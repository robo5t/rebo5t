...
io.write('\27[1;31mابعت يا روبوت توكن البوت يلا \nSend Me a Bot Token Now ↡\n\27[0;39;49m')
local TokenBot = io.read()
if TokenBot and TokenBot:match('(%d+):(.*)') then
local url , res = https.request('https://api.telegram.org/bot'..TokenBot..'/getMe')
local Json_Info = JSON.decode(url)
if res ~= 200 then
print('\27[1;34mالتوكن غلط ياض يا روبوت \nBot Token is Wrong\n')
else
io.write('\27[1;34mتم حفظ التوكن يا روبوت \nThe token been saved successfully \n\27[0;39;49m')
...
print('\27[1;34mلم يتم حفظ التوكن ياض يا روبوت جرب تاني \nToken not saved, try again')
end 
os.execute('lua RoBoT.lua')
end
if not Redis:get(SshId.."Info:Redis:User") then
io.write('\27[1;31mابعت يا روبوت يوزر المطور الاساسي \nDeveloper UserName saved ↡\n\27[0;39;49m')
local UserSudo = io.read():gsub('@','')
if UserSudo ~= '' then
io.write('\n\27[1;34mحفظت اليوزر يا روبوت \nDeveloper UserName saved \n\n\27[0;39;49m')
Redis:set(SshId.."Info:Redis:User",UserSudo)
else
print('\n\27[1;34mلم يتم حفظ اليوزر يا روبوت جرب تاني \nDeveloper UserName not saved\n')
end 
os.execute('lua RoBoT.lua')
end
if not Redis:get(SshId.."Info:Redis:User:ID") then
io.write('\27[1;31mابعت ايدي المطور الاساسي يا روبوت \nDeveloper ID saved ↡\n\27[0;39;49m')
local UserId = io.read()
if UserId and UserId:match('(%d+)') then
io.write('\n\27[1;34mتم حفظ الايدي يا روبوت \nDeveloper ID saved \n\n\27[0;39;49m')
Redis:set(SshId.."Info:Redis:User:ID",UserId)
else
print('\n\27[1;34mلم يتم حفظ الايدي ياض يا روبوت جرب تاني \nDeveloper ID not saved\n')
end 
os.execute('lua RoBoT.lua')
end
...
os.execute('chmod +x RoBoT;chmod +x Run;./Run')
end
...
RoBoT = Token:match("(%d+)")
os.execute('sudo rm -fr .CallBack-Bot/'..RoBoT)
LuaTele = luatele.set_config{api_id=2692371,api_hash='fe85fff033dfe0f328aeb02b4f784930',session_name=RoBoT,token=Token}
...
Status = 0
DevelopersQ = Redis:sismember(RoBoT.."RoBoT:DevelopersQ:Groups",UserId) 
Developers = Redis:sismember(RoBoT.."RoBoT:Developers:Groups",UserId) 
TheBasics = Redis:sismember(RoBoT.."RoBoT:TheBasics:Group"..ChatId,UserId) 
TheBasicsQ = Redis:sismember(RoBoT.."RoBoT:TheBasicsQ:Group"..ChatId,UserId) 
Originators = Redis:sismember(RoBoT.."RoBoT:Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(RoBoT.."RoBoT:Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(RoBoT.."RoBoT:Addictive:Group"..ChatId,UserId)
Distinguished = Redis:sismember(RoBoT.."RoBoT:Distinguished:Group"..ChatId,UserId)
...
Status = 'المبرمج روبوت'
elseif UserId == Sudo_Id then  
Status = 'المطور الاساسي'
elseif UserId == RoBoT then
Status = 'البوت'
...
Status = Redis:get(RoBoT.."RoBoT:Developer:Bot:Reply"..ChatId) or 'المطور'
elseif DevelopersQ then
Status = Redis:get(RoBoT.."RoBoT:DevelopersQ:Groups"..ChatId) or 'المطور الثانوي'
elseif TheBasicsQ then
Status = Redis:get(RoBoT.."RoBoT:PresidentQ:Group:Reply"..ChatId) or 'المالك'
elseif TheBasics then
Status = Redis:get(RoBoT.."RoBoT:President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Originators then
Status = Redis:get(RoBoT.."RoBoT:Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Managers then
Status = Redis:get(RoBoT.."RoBoT:Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(RoBoT.."RoBoT:Admin:Group:Reply"..ChatId) or 'الادمن'
elseif StatusMember == "chatMemberStatusCreator" then
Status = 'مالك الجروب'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = 'ادمن الجروب'
elseif Distinguished then
Status = Redis:get(RoBoT.."RoBoT:Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(RoBoT.."RoBoT:Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(RoBoT.."RoBoT:lockpin"..ChatId) then    
lock_pin = "【 ✅ 】"
else 
lock_pin = "【 ❌ 】"    
end
if Redis:get(RoBoT.."RoBoT:Lock:tagservr"..ChatId) then    
lock_tagservr = "【 ✅ 】"
else 
lock_tagservr = "【 ❌ 】"
end
if Redis:get(RoBoT.."RoBoT:Lock:text"..ChatId) then    
lock_text = "【 ✅ 】"
else 
lock_text = "【 ❌ 】 "    
end
if Redis:get(RoBoT.."RoBoT:Lock:AddMempar"..ChatId) == "kick" then
lock_add = "【 ✅ 】"
else 
lock_add = "【 ❌ 】 "    
end    
if Redis:get(RoBoT.."RoBoT:Lock:Join"..ChatId) == "kick" then
lock_join = "【 ✅ 】"
else 
lock_join = "【 ❌ 】 "    
end    
if Redis:get(RoBoT.."RoBoT:Lock:edit"..ChatId) then    
lock_edit = "【 ✅ 】"
else 
lock_edit = "【 ❌ 】 "    
end
if Redis:get(RoBoT.."RoBoT:Chek:Welcome"..ChatId) then
welcome = "【 ✅ 】"
else 
welcome = "【 ❌ 】 "    
end
if Redis:hget(RoBoT.."RoBoT:Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(RoBoT.."RoBoT:Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(RoBoT.."RoBoT:Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(RoBoT.."RoBoT:Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "【 ✅ 】"
else     
flood = "【 ❌ 】 "     
end
if Redis:get(RoBoT.."RoBoT:Lock:Photo"..ChatId) == "del" then
lock_photo = "【 ✅ 】" 
elseif Redis:get(RoBoT.."RoBoT:Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(RoBoT.."RoBoT:Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(RoBoT.."RoBoT:Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "【 ❌ 】 "   
end    
if Redis:get(RoBoT.."RoBoT:Lock:Contact"..ChatId) == "del" then
lock_phon = "【 ✅ 】" 
elseif Redis:get(RoBoT.."RoBoT:Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(RoBoT.."RoBoT:Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(RoBoT.."RoBoT:Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "【 ❌ 】 "    
end    
if Redis:get(RoBoT.."RoBoT:Lock:Link"..ChatId) == "del" then
lock_links = "【 ✅ 】"
elseif Redis:get(RoBoT.."RoBoT:Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(RoBoT.."RoBoT:Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(RoBoT.."RoBoT:Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "【 ❌ 】 "    
end
if Redis:get(RoBoT.."RoBoT:Lock:Cmd"..ChatId) == "del" then
lock_cmds = "【 ✅ 】"
elseif Redis:get(RoBoT.."RoBoT:Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(RoBoT.."RoBoT:Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(RoBoT.."RoBoT:Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "【 ❌ 】 "    
end
if Redis:get(RoBoT.."RoBoT:Lock:User:Name"..ChatId) == "del" then
lock_user = "【 ✅ 】"
elseif Redis:get(RoBoT.."RoBoT:Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(RoBoT.."RoBoT:Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(RoBoT.."RoBoT:Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "【 ❌ 】 "    
end
if Redis:get(RoBoT.."RoBoT:Lock:hashtak"..ChatId) == "del" then
lock_hash = "【 ✅ 】"
elseif Redis:get(RoBoT.."RoBoT:Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(RoBoT.."RoBoT:Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(RoBoT.."RoBoT:Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "【 ❌ 】 "    
end
if Redis:get(RoBoT.."RoBoT:Lock:vico"..ChatId) == "del" then
lock_muse = "【 ✅ 】"
elseif Redis:get(RoBoT.."RoBoT:Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(RoBoT.."RoBoT:Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(RoBoT.."RoBoT:Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "【 ❌ 】 "    
end 
if Redis:get(RoBoT.."RoBoT:Lock:Video"..ChatId) == "del" then
lock_ved = "【 ✅ 】"
elseif Redis:get(RoBoT.."RoBoT:Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(RoBoT.."RoBoT:Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(RoBoT.."RoBoT:Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "【 ❌ 】 "    
end
if Redis:get(RoBoT.."RoBoT:Lock:Animation"..ChatId) == "del" then
lock_gif = "【 ✅ 】"
elseif Redis:get(RoBoT.."RoBoT:Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(RoBoT.."RoBoT:Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(RoBoT.."RoBoT:Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "【 ❌ 】 "    
end
if Redis:get(RoBoT.."RoBoT:Lock:Sticker"..ChatId) == "del" then
lock_ste = "【 ✅ 】"
elseif Redis:get(RoBoT.."RoBoT:Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(RoBoT.."RoBoT:Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(RoBoT.."RoBoT:Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "【 ❌ 】 "    
end
if Redis:get(RoBoT.."RoBoT:Lock:geam"..ChatId) == "del" then
lock_geam = "【 ✅ 】"
elseif Redis:get(RoBoT.."RoBoT:Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(RoBoT.."RoBoT:Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(RoBoT.."RoBoT:Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "【 ❌ 】 "    
end    
...
if Redis:get(RoBoT.."RoBoT:Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "【 ✅ 】"
elseif Redis:get(RoBoT.."RoBoT:Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(RoBoT.."RoBoT:Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(RoBoT.."RoBoT:Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "【 ❌ 】 "
end
if Redis:get(RoBoT.."RoBoT:Lock:forward"..ChatId) == "del" then
lock_fwd = "【 ✅ 】"
elseif Redis:get(RoBoT.."RoBoT:Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(RoBoT.."RoBoT:Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(RoBoT.."RoBoT:Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "【 ❌ 】 "    
end    
if Redis:get(RoBoT.."RoBoT:Lock:Document"..ChatId) == "del" then
lock_file = "【 ✅ 】"
elseif Redis:get(RoBoT.."RoBoT:Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(RoBoT.."RoBoT:Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(RoBoT.."RoBoT:Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "【 ❌ 】 "    
end    
if Redis:get(RoBoT.."RoBoT:Lock:Unsupported"..ChatId) == "del" then
lock_self = "【 ✅ 】"
elseif Redis:get(RoBoT.."RoBoT:Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(RoBoT.."RoBoT:Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(RoBoT.."RoBoT:Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "【 ❌ 】 "    
end
if Redis:get(RoBoT.."RoBoT:Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "【 ✅ 】"
elseif Redis:get(RoBoT.."RoBoT:Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(RoBoT.."RoBoT:Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "【 ❌ 】 "    
end
if Redis:get(RoBoT.."RoBoT:Lock:Markdaun"..ChatId) == "del" then
lock_mark = "【 ✅ 】"
elseif Redis:get(RoBoT.."RoBoT:Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(RoBoT.."RoBoT:Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(RoBoT.."RoBoT:Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "【 ❌ 】 "    
end
if Redis:get(RoBoT.."RoBoT:Lock:Spam"..ChatId) == "del" then    
lock_spam = "【 ✅ 】"
elseif Redis:get(RoBoT.."RoBoT:Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(RoBoT.."RoBoT:Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(RoBoT.."RoBoT:Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "【 ❌ 】 "    
end        
...
return{
BanAll = Redis:sismember(RoBoT.."RoBoT:BanAll:Groups",UserId) ,
ktmall = Redis:sismember(RoBoT.."RoBoT:ktmAll:Groups",UserId) ,
BanGroup = Redis:sismember(RoBoT.."RoBoT:BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(RoBoT.."RoBoT:SilentGroup:Group"..ChatId,UserId)
}
end
...
local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,RoBoT).status
if GetMemberStatus.can_change_info then
...
JoinChannel = true
local chh = Redis:get(RoBoT.."chfalse")
if chh then
...
local msg_id = msg.id
var(msg.content)
if data.sender.luatele == "messageSenderChat" and Redis:get(RoBoT.."Lock:channell"..msg_chat_id) then
print(Redis:get(RoBoT.."chadmin"..msg_chat_id))
print(data.sender.chat_id)
if data.sender.chat_id ~= Redis:get(RoBoT.."chadmin"..msg_chat_id) then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
Redis:incr(RoBoT..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
...
if tonumber(msg.sender.user_id) == tonumber(RoBoT) then
...
msg.Name_Controller = 'المبرمج روبوت'
msg.The_Controller = 1
elseif The_ControllerAll(msg.sender.user_id) == true then  
msg.The_Controller = 1
msg.Name_Controller = 'المطور الاساسي '
elseif Redis:sismember(RoBoT.."RoBoT:DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(RoBoT.."HELPBEVQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 22
msg.Name_Controller = 'المساعد'
elseif Redis:sismember(RoBoT.."RoBoT:Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(RoBoT.."RoBoT:Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(RoBoT.."RoBoT:TheBasicsQ:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(RoBoT.."RoBoT:PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(RoBoT.."RoBoT:TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(RoBoT.."RoBoT:President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(RoBoT.."RoBoT:Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(RoBoT.."RoBoT:Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(RoBoT.."RoBoT:Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(RoBoT.."RoBoT:Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(RoBoT.."RoBoT:Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(RoBoT.."RoBoT:Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(RoBoT.."RoBoT:Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(RoBoT.."RoBoT:Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(RoBoT) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(RoBoT.."RoBoT:Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(RoBoT.."RoBoT:Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(RoBoT.."RoBoT:Status:Welcome"..msg_chat_id) then
local ban = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(RoBoT.."RoBoT:Welcome:Group"..msg_chat_id)
if Welcome then 
if ban.username then
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(RoBoT.."RoBoT:Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(RoBoT) then
return false
end
local floods = Redis:hget(RoBoT.."RoBoT:Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(RoBoT.."RoBoT:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(RoBoT.."RoBoT:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(RoBoT.."RoBoT:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(RoBoT.."RoBoT:Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(RoBoT.."RoBoT:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," ⌯ قام بالتكرار في الجروب وتم كتمه").Reply,"md",true)  
end
end
Redis:setex(RoBoT.."RoBoT:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(RoBoT.."RoBoT:Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(RoBoT.."RoBoT:Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
...
sens = 400  
if Redis:get(RoBoT.."RoBoT:Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(RoBoT.."RoBoT:Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(RoBoT.."RoBoT:Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(RoBoT.."RoBoT:Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(RoBoT.."RoBoT:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Developers then -- التوجيه
local Fwd_Group = Redis:get(RoBoT.."RoBoT:Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(RoBoT.."RoBoT:Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(RoBoT.."RoBoT:Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(RoBoT.."RoBoT:Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(RoBoT.."RoBoT:lockpin"..msg_chat_id)
...
Redis:incr(RoBoT.."Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(RoBoT.."Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(RoBoT.."Lock:Bot:kick"..msg_chat_id)
for k,v in pairs(msg.content.member_user_ids) do
local Info_User = LuaTele.getUser(v) 
print(v)
if v == tonumber(RoBoT) then
local N = (Redis:get(RoBoT.."Name:Bot") or "فايكينج")
photo = LuaTele.getUserProfilePhotos(RoBoT)
...
local Contact_Group = Redis:get(RoBoT.."Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(RoBoT.."RoBoT:Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(RoBoT.."RoBoT:Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(RoBoT.."RoBoT:Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(RoBoT.."RoBoT:Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(RoBoT.."RoBoT:Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(RoBoT.."RoBoT:Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(RoBoT.."RoBoT:Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(RoBoT.."RoBoT:Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(RoBoT.."RoBoT:Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(RoBoT.."RoBoT:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
...
Redis:del(RoBoT.."RoBoT:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(RoBoT.."RoBoT:Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(RoBoT.."RoBoT:Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Distinguished then 
local Hashtak_Group = Redis:get(RoBoT.."RoBoT:Lock:hashtak"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Distinguished then 
local comd_Group = Redis:get(RoBoT.."RoBoT:Lock:Cmd"..msg_chat_id)
...
if (Redis:get(RoBoT..'RoBoT:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(RoBoT.."RoBoT:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(RoBoT.."RoBoT:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(RoBoT.."RoBoT:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(RoBoT.."RoBoT:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(RoBoT.."RoBoT:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(RoBoT.."RoBoT:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(RoBoT.."RoBoT:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(RoBoT.."RoBoT:List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(RoBoT..'RoBoT:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ⌯ ارسل تحذير  "..Filters.."  عند ارساله*","md",true)  
end
end
if text and (Redis:get(RoBoT..'RoBoT:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(RoBoT.."RoBoT:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(RoBoT.."RoBoT:Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(RoBoT.."RoBoT:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(RoBoT..'RoBoT:FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ⌯ تم اضافه رد التحذير*","md",true)  
end
if text and (Redis:get(RoBoT..'RoBoT:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(RoBoT.."RoBoT:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(RoBoT.."RoBoT:Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(RoBoT.."RoBoT:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(RoBoT.."RoBoT:Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(RoBoT.."RoBoT:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(RoBoT.."RoBoT:Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(RoBoT.."RoBoT:List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(RoBoT.."RoBoT:Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(RoBoT..'RoBoT:FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(RoBoT.."RoBoT:Filter:Group:"..DelFilters..msg_chat_id)
...
if text and Redis:get(RoBoT.."RoBoT:All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(RoBoT.."RoBoT:All:Get:Reides:Commands:Group"..text)
if NewCmmd then
Redis:del(RoBoT.."RoBoT:All:Get:Reides:Commands:Group"..text)
Redis:del(RoBoT.."RoBoT:All:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(RoBoT.."RoBoT:All:Command:List:Group",text)
...
Redis:del(RoBoT.."RoBoT:All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(RoBoT.."RoBoT:All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(RoBoT.."RoBoT:All:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(RoBoT.."RoBoT:All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(RoBoT.."RoBoT:All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"* ⌯ ارسل الامر الجديد ليتم وضعه مكان القديم*","md",true)  
end
if text and Redis:get(RoBoT.."RoBoT:All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(RoBoT.."RoBoT:All:Command:Reids:Group:New"..msg_chat_id)
Redis:set(RoBoT.."RoBoT:All:Get:Reides:Commands:Group"..text,NewCmd)
Redis:sadd(RoBoT.."RoBoT:All:Command:List:Group",text)
Redis:del(RoBoT.."RoBoT:All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"* ⌯ تم حفظ الامر باسم ⇦  "..text..'  *',"md",true)
end

if text and Redis:get(RoBoT.."RoBoT:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(RoBoT.."RoBoT:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(RoBoT.."RoBoT:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(RoBoT.."RoBoT:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(RoBoT.."RoBoT:Command:List:Group"..msg_chat_id,text)
LuaTele.sendText(msg_chat_id,msg_id,"* ⌯ تم ازالة هاذا ⇦  "..text.."  *","md",true)
else
LuaTele.sendText(msg_chat_id,msg_id,"* ⌯ لا يوجد امر بهاذا الاسم*","md",true)
end
Redis:del(RoBoT.."RoBoT:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(RoBoT.."RoBoT:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(RoBoT.."RoBoT:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(RoBoT.."RoBoT:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(RoBoT.."RoBoT:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"* ⌯ ارسل الامر الجديد ليتم وضعه مكان القديم*","md",true)  
end
if text and Redis:get(RoBoT.."RoBoT:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(RoBoT.."RoBoT:Command:Reids:Group:New"..msg_chat_id)
Redis:set(RoBoT.."RoBoT:Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(RoBoT.."RoBoT:Command:List:Group"..msg_chat_id,text)
Redis:del(RoBoT.."RoBoT:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"* ⌯ تم حفظ الامر باسم ⇦  "..text..'  *',"md",true)
end
if Redis:get(RoBoT.."RoBoT:Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(RoBoT.."RoBoT:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:set(RoBoT.."RoBoT:Group:Link"..msg_chat_id,LinkGroup)
Redis:del(RoBoT.."RoBoT:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"* ⌯ تم حفظ الرابط بنجاح*","md",true)         
end
end 
if Redis:get(RoBoT.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(RoBoT.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
return LuaTele.sendText(msg_chat_id,msg_id,"* ⌯ تم الغاء حفظ الترحيب*","md",true)   
end 
Redis:del(RoBoT.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(RoBoT.."RoBoT:Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"* ⌯ تم حفظ ترحيب الجروب*","md",true)     
end
if Redis:get(RoBoT.."RoBoT:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(RoBoT.."RoBoT:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"* ⌯ تم الغاء حفظ القوانين*","md",true)   
end 
Redis:set(RoBoT.."RoBoT:Group:Rules" .. msg_chat_id,text) 
Redis:del(RoBoT.."RoBoT:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"* ⌯ تم حفظ قوانين الجروب*","md",true)  
end  
if Redis:get(RoBoT.."RoBoT:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(RoBoT.."RoBoT:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
if text  then
local test = Redis:get(RoBoT.."RoBoT:Text:Manager"..msg.sender.user_id..":"..msg_chat_id.."")
if Redis:get(RoBoT.."RoBoT:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(RoBoT.."RoBoT:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(RoBoT.."RoBoT:Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(RoBoT.."RoBoT:Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
end   
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(RoBoT.."RoBoT:Add:Rd:Manager:Text"..test..msg_chat_id, text)  
end  
return LuaTele.sendText(msg_chat_id,msg_id,"* ⌯ تم حفظ في قائمه الردود *\n* ⌯ ارسل "..test.." لرئية الرد*","md",true)  
end  
end
if text and text:match("^(.*)$") then
if Redis:get(RoBoT.."RoBoT:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(RoBoT.."RoBoT:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(RoBoT.."RoBoT:Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(RoBoT.."RoBoT:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(RoBoT.."RoBoT:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(RoBoT.."RoBoT:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(RoBoT.."RoBoT:Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(RoBoT.."RoBoT:Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(RoBoT.."RoBoT:Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(RoBoT.."RoBoT:Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(RoBoT.."RoBoT:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(RoBoT.."RoBoT:Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:sadd(RoBoT.."RoBoT:List:Manager"..msg_chat_id.."", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
{
{text = '  𝑺𝑶𝑼𝑹𝑪𝑬 𝑺𝑨𝑺𝑨  ', url='https://t.me/llIlllllllllllII'},
},
}
}
...
if text and text:match("^(.*)$") then
if Redis:get(RoBoT.."RoBoT:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(RoBoT.."RoBoT:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(RoBoT.."RoBoT:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(RoBoT.."RoBoT:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(RoBoT.."RoBoT:Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(RoBoT.."RoBoT:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(RoBoT.."RoBoT:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(RoBoT.."RoBoT:List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"* ⌯ تم حذف الرد في قائمه الردود *","md",true)  
return false
end
end
if text and Redis:get(RoBoT.."RoBoT:Status:ReplySudo"..msg_chat_id) then
local anemi = Redis:get(RoBoT.."RoBoT:Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(RoBoT.."RoBoT:Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(RoBoT.."RoBoT:Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(RoBoT.."RoBoT:Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(RoBoT.."RoBoT:Add:Rd:Sudo:Photo"..text)
local video = Redis:get(RoBoT.."RoBoT:Add:Rd:Sudo:Video"..text)
local document = Redis:get(RoBoT.."RoBoT:Add:Rd:Sudo:File"..text)
local audio = Redis:get(RoBoT.."RoBoT:Add:Rd:Sudo:Audio"..text)
local video_note = Redis:get(RoBoT.."RoBoT:Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(RoBoT..'RoBoT:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(RoBoT..'RoBoT:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
if text and Redis:get(RoBoT.."RoBoT:Status:Reply"..msg_chat_id) then
local anemi = Redis:get(RoBoT.."RoBoT:Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(RoBoT.."RoBoT:Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(RoBoT.."RoBoT:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(RoBoT.."RoBoT:Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(RoBoT.."RoBoT:Add:Rd:Manager:Photo"..text..msg_chat_id)
local video = Redis:get(RoBoT.."RoBoT:Add:Rd:Manager:Video"..text..msg_chat_id)
local document = Redis:get(RoBoT.."RoBoT:Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(RoBoT.."RoBoT:Add:Rd:Manager:Audio"..text..msg_chat_id)
local video_note = Redis:get(RoBoT.."RoBoT:Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(RoBoT..'RoBoT:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
if text then
local test = Redis:get(RoBoT.."RoBoT:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(RoBoT.."RoBoT:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(RoBoT.."RoBoT:Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(RoBoT.."RoBoT:Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(RoBoT.."RoBoT:Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
end   
if msg.content.animation then   
Redis:set(RoBoT.."RoBoT:Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(RoBoT.."RoBoT:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text and text:match("^(.*)$") then
if Redis:get(RoBoT.."RoBoT:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(RoBoT.."RoBoT:Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(RoBoT.."RoBoT:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(RoBoT.."RoBoT:List:Rd:Sudo", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(RoBoT.."RoBoT:Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
Redis:del(RoBoT..'RoBoT:'..v..text)
end
Redis:del(RoBoT.."RoBoT:Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(RoBoT.."RoBoT:List:Rd:Sudo", text)
return LuaTele.sendText(msg_chat_id,msg_id,"* ⌯ تم حذف الرد في الردود العامه *","md",true)  
end
end
if Redis:get(RoBoT.."RoBoT:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '  الغاء الامر  ' then   
Redis:del(RoBoT.."RoBoT:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n☆︙تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(RoBoT.."RoBoT:ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(RoBoT.."RoBoT:PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
...
Redis:set(RoBoT.."RoBoT:PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(RoBoT.."RoBoT:PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(RoBoT.."RoBoT:PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(RoBoT.."RoBoT:PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(RoBoT.."RoBoT:PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(RoBoT.."RoBoT:PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(RoBoT.."RoBoT:PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v,0,text,"md",true)
Redis:set(RoBoT.."RoBoT:PinMsegees:"..v,text)
end
end
...
if Redis:get(RoBoT.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '  الغاء الامر  ' then   
Redis:del(RoBoT.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n*⌯ تم الغاء الاذاعه بالتوجيه للخاص*","md",true)    
end 
if msg.forward_info then 
local list = Redis:smembers(RoBoT.."RoBoT:Num:User:Pv") 
...
if Redis:get(RoBoT.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '  الغاء الامر  ' then   
Redis:del(RoBoT.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if Redis:get(RoBoT.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '  الغاء الامر  ' then   
Redis:del(RoBoT.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n*⌯ تم الغاء الاذاعه للمجموعات*","md",true)  
end 
local list = Redis:smembers(RoBoT.."RoBoT:ChekBotAdd") 
if msg.content.voice_chats then
...
------------------------------------------------------------------------------------------------------------
if Redis:get(RoBoT.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '  الغاء الامر  ' then   
Redis:del(RoBoT.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if text and Redis:get(RoBoT..'RoBoT:GetTexting:DevRoBoT'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == '  الغاء الامر  ' then 
Redis:del(RoBoT..'RoBoT:GetTexting:DevRoBoT'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,' ⌯ تم الغاء حفظ كليشة المطور')
end
Redis:set(RoBoT..'RoBoT:Texting:DevRoBoT',text)
Redis:del(RoBoT..'RoBoT:GetTexting:DevRoBoT'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,' ⌯ تم حفظ كليشة المطور')
end
if Redis:get(RoBoT.."RoBoT:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n ⌯ تم الغاء امر تعين الايدي عام","md",true)  
Redis:del(RoBoT.."RoBoT:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(RoBoT.."RoBoT:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(RoBoT.."RoBoT:Set:Id:Groups",text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,' ⌯ تم تعين الايدي عام',"md",true)  
end
if Redis:get(RoBoT.."RoBoT:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n ⌯ تم الغاء امر تعين الايدي","md",true)  
Redis:del(RoBoT.."RoBoT:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(RoBoT.."RoBoT:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(RoBoT.."RoBoT:Set:Id:Group"..msg.chat_id,text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,' ⌯ تم تعين الايدي الجديد',"md",true)  
end
if Redis:get(RoBoT.."RoBoT:Change:RoBoT:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == '  الغاء الامر  ' then   
Redis:del(RoBoT.."RoBoT:Change:RoBoT:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n ⌯ تم الغاء امر تغير اسم البوت","md",true)  
end 
Redis:del(RoBoT.."RoBoT:Change:RoBoT:Name:Bot"..msg.sender.user_id) 
Redis:set(RoBoT.."RoBoT:Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, " ⌯ تم تغير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(RoBoT.."RoBoT:Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == '  الغاء الامر  ' then   
Redis:del(RoBoT.."RoBoT:Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n ⌯ تم الغاء امر تغير كليشه start","md",true)  
end 
Redis:del(RoBoT.."RoBoT:Change:Start:Bot"..msg.sender.user_id) 
Redis:set(RoBoT.."RoBoT:Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, " ⌯ تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(RoBoT.."RoBoT:Game:Smile"..msg.chat_id) then
if text == Redis:get(RoBoT.."RoBoT:Game:Smile"..msg.chat_id) then
Redis:incrby(RoBoT.."RoBoT:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(RoBoT.."RoBoT:Game:Smile"..msg.chat_id)
...
if Redis:get(RoBoT.."RoBoT:Game:Monotonous"..msg.chat_id) then
if text == Redis:get(RoBoT.."RoBoT:Game:Monotonous"..msg.chat_id) then
Redis:del(RoBoT.."RoBoT:Game:Monotonous"..msg.chat_id)
Redis:incrby(RoBoT.."RoBoT:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(RoBoT.."RoBoT:Game:Riddles"..msg.chat_id) then
if text == Redis:get(RoBoT.."RoBoT:Game:Riddles"..msg.chat_id) then
Redis:incrby(RoBoT.."RoBoT:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(RoBoT.."RoBoT:Game:Riddles"..msg.chat_id)
...
if Redis:get(RoBoT.."RoBoT:Game:Meaningof"..msg.chat_id) then
if text == Redis:get(RoBoT.."RoBoT:Game:Meaningof"..msg.chat_id) then
Redis:incrby(RoBoT.."RoBoT:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(RoBoT.."RoBoT:Game:Meaningof"..msg.chat_id)
...
if Redis:get(RoBoT.."RoBoT:Game:Reflection"..msg.chat_id) then
if text == Redis:get(RoBoT.."RoBoT:Game:Reflection"..msg.chat_id) then
Redis:incrby(RoBoT.."RoBoT:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(RoBoT.."RoBoT:Game:Reflection"..msg.chat_id)
...
if Redis:get(RoBoT.."RoBoT:Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id," ⌯ عذرا لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(RoBoT.."RoBoT:Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(RoBoT.."RoBoT:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(RoBoT.."RoBoT:Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(RoBoT.."RoBoT:Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id," ⌯ مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(RoBoT.."RoBoT:SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(RoBoT.."RoBoT:SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(RoBoT.."RoBoT:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(RoBoT.."RoBoT:Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(RoBoT.."RoBoT:Game:Difference"..msg.chat_id) then
if text == Redis:get(RoBoT.."RoBoT:Game:Difference"..msg.chat_id) then 
Redis:del(RoBoT.."RoBoT:Game:Difference"..msg.chat_id)
Redis:incrby(RoBoT.."RoBoT:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(RoBoT.."RoBoT:Game:Example"..msg.chat_id) then
if text == Redis:get(RoBoT.."RoBoT:Game:Example"..msg.chat_id) then 
Redis:del(RoBoT.."RoBoT:Game:Example"..msg.chat_id)
Redis:incrby(RoBoT.."RoBoT:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if text then
local NewCmmd = Redis:get(RoBoT.."RoBoT:All:Get:Reides:Commands:Group"..text) or Redis:get(RoBoT.."RoBoT:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/llIlllllllllllII'}, },}}
...
if tonumber(RoBoT) ~= tonumber(FilesJson.BotId) then
return LuaTele.sendText(msg_chat_id,msg_id,' ⌯ عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
Y = Y + 1
Redis:sadd(RoBoT..'RoBoT:Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(RoBoT.."RoBoT:ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(RoBoT.."RoBoT:TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(RoBoT.."RoBoT:Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(RoBoT.."RoBoT:Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(RoBoT.."RoBoT:Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(RoBoT.."RoBoT:Distinguished:Group"..GroupId,v)
end
end 
end
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(RoBoT) then 
return LuaTele.sendText(msg_chat_id,msg_id,' ⌯ عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(RoBoT.."RoBoT:ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(RoBoT.."RoBoT:Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(RoBoT.."RoBoT:Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(RoBoT.."RoBoT:Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(RoBoT.."RoBoT:TheBasics:Group"..idg,idASAS)
end;end
end
...
--os.execute('rm -rf RoBoT.lua')
--download('https://raw.githubusercontent.com/kmesgdknlksrf/imback/master/RoBoT.lua','RoBoT.lua')
...
Redis:del(RoBoT.."RoBoT:SendBcBot") 
...
Redis:set(RoBoT.."RoBoT:SendBcBot",true) 
...
Redis:set(RoBoT.."RoBoT:LeftBot",true) 
return LuaTele.sendText(msg_chat_id,msg_id," ⌯ تم تفعيل المغادره للمطورين ","md",true)
end
if (Redis:get(RoBoT.."RoBoT:AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == '  الغاء الامر  ' then   
Redis:del(RoBoT.."RoBoT:AddSudosNew"..msg_chat_id)
...
Redis:set(RoBoT.."RoBoT:AddSudosNew"..msg_chat_id,true)
...
local Groups = Redis:smembers(RoBoT..'RoBoT:ChekBotAdd')  
local UsersBot = Redis:smembers(RoBoT..'RoBoT:Num:User:Pv')  
local Get_Json = '{"BotId": '..RoBoT..','  
if #UsersBot ~= 0 then 
...
local President = Redis:smembers(RoBoT.."RoBoT:TheBasics:Group"..v)
local Constructor = Redis:smembers(RoBoT.."RoBoT:Originators:Group"..v)
local Manager = Redis:smembers(RoBoT.."RoBoT:Managers:Group"..v)
local Admin = Redis:smembers(RoBoT.."RoBoT:Addictive:Group"..v)
local Vips = Redis:smembers(RoBoT.."RoBoT:Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
Redis:set(RoBoT..'RoBoT:Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
local photo = LuaTele.getUserProfilePhotos(RoBoT)
local UserInfo = LuaTele.getUser(RoBoT)
for Name_User in string.gmatch(UserInfo.first_name, "[^%s]+" ) do
UserInfo.first_name = Name_User
break
end 
NamesBot = (Redis:get(RoBoT.."RoBoT:Name:Bot") or "فايكينج")
Groups = (Redis:scard(RoBoT..'RoBoT:ChekBotAdd') or 0)
Users = (Redis:scard(RoBoT..'RoBoT:Num:User:Pv') or 0)
if photo.total_count > 0 then
...
keyboard.inline_keyboard = {
{
{text =first_name, url = "https://t.me/llIlllllllllllII"}
},
{
{text = selva, url = 't.me/llIlllllllllllII'}, 
},
{
{text = Grosupsw, url = 't.me/llIlllllllllllII'}, 
},
{
{text = Usperos, url = 't.me/llIlllllllllllII'}, 
},
{
{text = 'اضف البوت لمجموعتك ✅', url = 't.me/'..UserBot..'?startgroup=new'},
},
...
if Redis:sismember(RoBoT.."RoBoT:ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(RoBoT..'RoBoT:Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,' ⌯ عدد الاعضاء قليل لا يمكن تفعيل الجروب  يجب ان يكوم اكثر من :'..Redis:get(RoBoT..'RoBoT:Num:Add:Bot'),"md",true)  
end
...
Redis:sadd(RoBoT.."RoBoT:ChekBotAdd",msg_chat_id)
Redis:set(RoBoT.."RoBoT:Status:Id"..msg_chat_id,true) ;Redis:set(RoBoT.."RoBoT:Status:Reply"..msg_chat_id,true) ;Redis:set(RoBoT.."RoBoT:Status:ReplySudo"..msg_chat_id,true) ;Redis:set(RoBoT.."RoBoT:Status:BanId"..msg_chat_id,true) ;Redis:set(RoBoT.."RoBoT:Status:SetId"..msg_chat_id,true) 
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(RoBoT.."RoBoT:ChekBotAdd",msg_chat_id) then
...
Redis:srem(RoBoT.."RoBoT:ChekBotAdd",msg_chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ⌯ اسم الجروب -› *['..Get_Chat.title..']('..Info_Chats.invite_link.invite_link..')* \n ⌯ تم التعطيل من قبل *','md',true)
end
end
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(RoBoT.."RoBoT:ChekBotAdd",msg_chat_id) then
if text == "ايدي" or text == "الايدي" or text == "Id" or text == "ID" and msg.reply_to_message_id == 0 then
if not Redis:get(RoBoT.."RoBoT:Status:Id"..msg_chat_id) then
return false
end
...
local TotalMsg = Redis:get(RoBoT..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(RoBoT..'Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(RoBoT.."Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(RoBoT.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
...
Get_Is_Id = Redis:get(RoBoT.."RoBoT:Set:Id:Groups") or Redis:get(RoBoT.."Set:Id:Group"..msg_chat_id)
if Redis:get(RoBoT.."RoBoT:Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
local TotalMsg = Redis:get(RoBoT..'RoBoT:Num:Message:User'..msg_chat_id..':'..UserId) or 0
local TotalEdit = Redis:get(RoBoT..'RoBoT:Num:Message:Edit'..msg_chat_id..UserId) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumAdd = Redis:get(RoBoT.."RoBoT:Num:Add:Memp"..msg.chat_id..":"..UserId) or 0
local NumberGames = Redis:get(RoBoT.."RoBoT:Num:Add:Games"..msg.chat_id..UserId) or 0
if Get_Is_Id then
local Get_Is_Id = Get_Is_Id:gsub('#AddMem',NumAdd) 
...
Redis:set(RoBoT.."allM:numdel"..msg.chat_id,Numbardel) 
...
local list = Redis:smembers(RoBoT.."allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
t = "⌯ تم مسح "..k.." من الوسائط الموجوده"
LuaTele.deleteMessages(msg.chat_id,{[1]= Message})
Redis:del(RoBoT.."allM"..msg.chat_id)
end
end
if #list == 0 then
...
local gmria = Redis:scard(RoBoT.."allM"..msg.chat_id)  
...
Redis:del(RoBoT.."Status:Del:Media"..msg.chat_id)
...
Redis:set(RoBoT.."Status:Del:Media"..msg.chat_id,true)
...
local StatusMember = LuaTele.getChatMember(msg_chat_id,RoBoT).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,' ⌯ البوت عضو في الجروب ',"md",true) 
end
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,RoBoT).status
if GetMemberStatus.can_change_info then
change_info = '【 ✅ 】' else change_info = '【 ❌ 】'
end
if GetMemberStatus.can_delete_messages then
...
if not Redis:sismember(RoBoT.."RoBoT:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"* ⌯ تم تنزيله مطور ثانوي مسبقا *").Reply,"md",true)  
else
Redis:srem(RoBoT.."RoBoT:DevelopersQ:Groups",UserId_Info.id) 
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(RoBoT..'Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n⌯ عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
if not Redis:sismember(RoBoT.."HELPBEVQ:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"⌯ تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(RoBoT.."HELPBEVQ:Groups")
Redis:del(RoBoT.."HELPBEVQ:Groups", bana.id)
Redis:del(RoBoT.."id:HELPBEVQ:Groups", bana.id)
...
if not Redis:sismember(RoBoT.."RoBoT:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌯ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(RoBoT.."RoBoT:Developers:Groups",UserId_Info.id) 
...
if not Redis:sismember(RoBoT.."RoBoT:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌯ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(RoBoT.."RoBoT:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(RoBoT.."RoBoT:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌯ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(RoBoT.."RoBoT:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(RoBoT.."RoBoT:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌯ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(RoBoT.."RoBoT:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(RoBoT.."RoBoT:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌯ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(RoBoT.."RoBoT:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(RoBoT.."RoBoT:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌯ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(RoBoT.."RoBoT:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(RoBoT.."RoBoT:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌯ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(RoBoT.."RoBoT:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(RoBoT.."RoBoT:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(RoBoT.."RoBoT:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(RoBoT.."HELPBEVQ:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌯ تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(RoBoT.."HELPBEVQ:Groups")
Redis:del(RoBoT.."HELPBEVQ:Groups", Message_Reply.sender.user_id)
Redis:del(RoBoT.."id:HELPBEVQ:Groups", Message_Reply.sender.user_id)
...
if not Redis:sismember(RoBoT.."RoBoT:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⌯ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(RoBoT.."RoBoT:Developers:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(RoBoT.."RoBoT:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⌯ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(RoBoT.."RoBoT:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(RoBoT.."RoBoT:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(RoBoT.."RoBoT:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(RoBoT.."RoBoT:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(RoBoT.."RoBoT:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(RoBoT.."RoBoT:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(RoBoT.."RoBoT:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(RoBoT.."RoBoT:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(RoBoT.."RoBoT:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(RoBoT.."RoBoT:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(RoBoT.."RoBoT:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(RoBoT.."RoBoT:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"* ⌯ تم تنزيله مطور ثانوي مسبقا *").Reply,"md",true)  
else
Redis:srem(RoBoT.."RoBoT:DevelopersQ:Groups",UserId) 
...
if not Redis:sismember(RoBoT.."HELPBEVQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌯ تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(RoBoT.."HELPBEVQ:Groups")
Redis:del(RoBoT.."HELPBEVQ:Groups", UserId)
Redis:del(RoBoT.."id:HELPBEVQ:Groups", UserId)
...
if not Redis:sismember(RoBoT.."RoBoT:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ⌯ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(RoBoT.."RoBoT:Developers:Groups",UserId) 
...
if not Redis:sismember(RoBoT.."RoBoT:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⌯ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(RoBoT.."RoBoT:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(RoBoT.."RoBoT:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⌯ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(RoBoT.."RoBoT:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(RoBoT.."RoBoT:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⌯ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(RoBoT.."RoBoT:Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(RoBoT.."RoBoT:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⌯ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(RoBoT.."RoBoT:Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(RoBoT.."RoBoT:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⌯ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(RoBoT.."RoBoT:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(RoBoT.."RoBoT:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⌯ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(RoBoT.."RoBoT:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(RoBoT.."RoBoT:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌯ تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(RoBoT.."RoBoT:DevelopersQ:Groups",UserId_Info.id) 
...
if Redis:sismember(RoBoT.."HELPBEVQ:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"⌯ تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:del(RoBoT.."HELPBEVQ:Groups")
Redis:sadd(RoBoT.."HELPBEVQ:Groups", UserId)
Redis:set(RoBoT.."id:HELPBEVQ:Groups", UserId)
...
if Redis:sismember(RoBoT.."RoBoT:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌯ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(RoBoT.."RoBoT:Developers:Groups",UserId_Info.id) 
...
if Redis:sismember(RoBoT.."RoBoT:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌯ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(RoBoT.."RoBoT:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(RoBoT.."RoBoT:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌯ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(RoBoT.."RoBoT:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(RoBoT.."RoBoT:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌯ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(RoBoT.."RoBoT:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(RoBoT.."RoBoT:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌯ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(RoBoT.."RoBoT:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not msg.Originators and not Redis:get(RoBoT.."RoBoT:Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id," ⌯ تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(RoBoT.."RoBoT:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌯ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(RoBoT.."RoBoT:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(RoBoT.."RoBoT:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌯ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(RoBoT.."RoBoT:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(RoBoT.."RoBoT:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(RoBoT.."RoBoT:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(RoBoT.."HELPBEVQ:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌯ تم ترقيته مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(RoBoT.."HELPBEVQ:Groups")
Redis:sadd(RoBoT.."HELPBEVQ:Groups", Message_Reply.sender.user_id)
Redis:set(RoBoT.."id:HELPBEVQ:Groups", Message_Reply.sender.user_id)
...
if Redis:sismember(RoBoT.."RoBoT:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⌯ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(RoBoT.."RoBoT:Developers:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(RoBoT.."RoBoT:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⌯ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(RoBoT.."RoBoT:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(RoBoT.."RoBoT:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(RoBoT.."RoBoT:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(RoBoT.."RoBoT:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⌯ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(RoBoT.."RoBoT:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(RoBoT.."RoBoT:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⌯ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(RoBoT.."RoBoT:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(RoBoT.."RoBoT:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⌯ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(RoBoT.."RoBoT:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(RoBoT.."RoBoT:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⌯ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(RoBoT.."RoBoT:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(RoBoT.."RoBoT:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ⌯ تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(RoBoT.."RoBoT:DevelopersQ:Groups",UserId) 
...
if Redis:sismember(RoBoT.."HELPBEVQ:Groups",UserId) then
...
if Redis:sismember(RoBoT.."RoBoT:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ⌯ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(RoBoT.."RoBoT:Developers:Groups",UserId) 
...
if Redis:sismember(RoBoT.."RoBoT:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⌯ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(RoBoT.."RoBoT:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(RoBoT.."RoBoT:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⌯ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(RoBoT.."RoBoT:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(RoBoT.."RoBoT:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⌯ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(RoBoT.."RoBoT:Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(RoBoT.."RoBoT:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⌯ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(RoBoT.."RoBoT:Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(RoBoT.."RoBoT:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⌯ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(RoBoT.."RoBoT:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(RoBoT.."RoBoT:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⌯ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(RoBoT.."RoBoT:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(RoBoT.."RoBoT:Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(RoBoT.."RoBoT:President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(RoBoT.."RoBoT:Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(RoBoT.."RoBoT:PresidentQ:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(RoBoT.."RoBoT:Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(RoBoT.."RoBoT:Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(RoBoT.."RoBoT:Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(RoBoT.."RoBoT:DevelopersQ:Groups") 
...
local Info_Members = Redis:smembers(RoBoT.."RoBoT:Developers:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(RoBoT.."RoBoT:TheBasicsQ:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(RoBoT.."RoBoT:TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(RoBoT.."RoBoT:Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(RoBoT.."RoBoT:Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(RoBoT.."RoBoT:Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(RoBoT.."RoBoT:Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(RoBoT.."RoBoT:BanAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(RoBoT.."RoBoT:ktmAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(RoBoT.."RoBoT:BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(RoBoT.."RoBoT:SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(RoBoT.."RoBoT:Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"* ⌯ تم تفعيل الرابط *","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(RoBoT.."RoBoT:Status:Welcome"..msg_chat_id,true) 
...
Redis:set(RoBoT.."RoBoT:Status:Id"..msg_chat_id,true) 
...
Redis:set(RoBoT.."RoBoT:Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(RoBoT.."RoBoT:Status:Reply"..msg_chat_id,true) 
...
Redis:set(RoBoT.."RoBoT:Status:ReplySudo"..msg_chat_id,true) 
...
Redis:set(RoBoT.."RoBoT:Status:BanId"..msg_chat_id,true) 
...
Redis:set(RoBoT.."RoBoT:BotFree",true) 
...
Redis:set(RoBoT.."RoBoT:TwaslBot",true) 
...
if text and text:match("^(.*)$") then
if Redis:get(RoBoT.."RoBoT1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(RoBoT.."RoBoT1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(RoBoT.."RoBoT1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(RoBoT.."RoBoT1:List:Rd:Sudo"..msg.chat_id, text)
return  LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(RoBoT.."RoBoT1:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:del(RoBoT..'RoBoT1:Add:Rd:Sudo:Text'..text..msg.chat_id)
Redis:del(RoBoT..'RoBoT1:Add:Rd:Sudo:Text1'..text..msg.chat_id)
Redis:del(RoBoT..'RoBoT1:Add:Rd:Sudo:Text2'..text..msg.chat_id)
Redis:del(RoBoT.."RoBoT1:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(RoBoT.."RoBoT1:List:Rd:Sudo"..msg.chat_id, text)
...
local list = Redis:smembers(RoBoT.."RoBoT1:List:Rd:Sudo"..msg.chat_id)
for k,v in pairs(list) do  
Redis:del(RoBoT.."RoBoT1:Add:Rd:Sudo:Text"..v..msg.chat_id) 
Redis:del(RoBoT.."RoBoT1:Add:Rd:Sudo:Text1"..v..msg.chat_id) 
Redis:del(RoBoT.."RoBoT1:Add:Rd:Sudo:Text2"..v..msg.chat_id) 
Redis:del(RoBoT.."RoBoT1:List:Rd:Sudo"..msg.chat_id)
end
...
Redis:set(RoBoT.."RoBoT1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(RoBoT.."RoBoT1:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(RoBoT.."RoBoT1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(RoBoT.."RoBoT1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(RoBoT.."RoBoT1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(RoBoT.."RoBoT1:Add:Rd:Sudo:Text"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(RoBoT.."RoBoT1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(RoBoT.."RoBoT1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(RoBoT.."RoBoT1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(RoBoT.."RoBoT1:Add:Rd:Sudo:Text1"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(RoBoT.."RoBoT1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(RoBoT.."RoBoT1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(RoBoT.."RoBoT1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(RoBoT.."RoBoT1:Add:Rd:Sudo:Text2"..test..msg.chat_id, text)  
end  
...
if text then
local Text = Redis:get(RoBoT.."RoBoT1:Add:Rd:Sudo:Text"..text..msg.chat_id)   
local Text1 = Redis:get(RoBoT.."RoBoT1:Add:Rd:Sudo:Text1"..text..msg.chat_id)   
local Text2 = Redis:get(RoBoT.."RoBoT1:Add:Rd:Sudo:Text2"..text..msg.chat_id)   
...
if text and text:match("^(.*)$") then
if Redis:get(RoBoT.."RoBoT11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ')
Redis:set(RoBoT.."RoBoT11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(RoBoT.."RoBoT11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(RoBoT.."RoBoT11:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if Redis:get(RoBoT.."RoBoT11:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف الرد من ردود المتعدده")
Redis:del(RoBoT..'RoBoT11:Add:Rd:Sudo:Text'..text)
Redis:del(RoBoT..'RoBoT11:Add:Rd:Sudo:Text1'..text)
Redis:del(RoBoT..'RoBoT11:Add:Rd:Sudo:Text2'..text)
Redis:del(RoBoT.."RoBoT11:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(RoBoT.."RoBoT11:List:Rd:Sudo", text)
return false
end
end
...
local list = Redis:smembers(RoBoT.."RoBoT11:List:Rd:Sudo")
for k,v in pairs(list) do  
Redis:del(RoBoT.."RoBoT11:Add:Rd:Sudo:Text"..v) 
Redis:del(RoBoT.."RoBoT11:Add:Rd:Sudo:Text1"..v) 
Redis:del(RoBoT.."RoBoT11:Add:Rd:Sudo:Text2"..v)   
Redis:del(RoBoT.."RoBoT11:List:Rd:Sudo")
end
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف ردود المتعدده")
end
...
Redis:set(RoBoT.."RoBoT11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الرد الذي اريد اضافته")
end
...
Redis:set(RoBoT.."RoBoT11:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(RoBoT.."RoBoT11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(RoBoT.."RoBoT11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(RoBoT.."RoBoT11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(RoBoT.."RoBoT11:Add:Rd:Sudo:Text"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
...
if text then  
local test = Redis:get(RoBoT.."RoBoT11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(RoBoT.."RoBoT11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(RoBoT.."RoBoT11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(RoBoT.."RoBoT11:Add:Rd:Sudo:Text1"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
...
if text then  
local test = Redis:get(RoBoT.."RoBoT11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(RoBoT.."RoBoT11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(RoBoT.."RoBoT11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(RoBoT.."RoBoT11:Add:Rd:Sudo:Text2"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد")
return false  
end  
...
if text then
local Text = Redis:get(RoBoT.."RoBoT11:Add:Rd:Sudo:Text"..text)   
local Text1 = Redis:get(RoBoT.."RoBoT11:Add:Rd:Sudo:Text1"..text)   
local Text2 = Redis:get(RoBoT.."RoBoT11:Add:Rd:Sudo:Text2"..text)   
if Text or Text1 or Text2 then 
local texting = {
Text,
Text1,
...
Redis:sadd(RoBoT.."RoBoT:allM"..msg.chat_id, msg.id)
if Redis:get(RoBoT.."RoBoT:Status:Del:Media"..msg.chat_id) then    
local gmedia = Redis:scard(RoBoT.."RoBoT:allM"..msg.chat_id)  
if gmedia >= 200 then
local liste = Redis:smembers(RoBoT.."RoBoT:allM"..msg.chat_id)
...
LuaTele.sendText(msg_chat_id,msg_id, t)
Redis:del(RoBoT.."RoBoT:allM"..msg.chat_id)
end
end
end
...
local list = Redis:smembers(RoBoT.."RoBoT:allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
t = " ⌯ تم مسح "..k.." من الوسائط الموجوده"
...
local gmria = Redis:scard(RoBoT.."RoBoT:allM"..msg.chat_id)  
 LuaTele.sendText(msg_chat_id,msg_id,"⌯ عدد الميديا الموجود هو〘* "..gmria.." *〙","md")
end
if text == "تعطيل المسح التلقائي" then        
if not msg.TheBasics then
...
Redis:del(RoBoT.."RoBoT:Status:Del:Media"..msg.chat_id)
 LuaTele.sendText(msg_chat_id,msg_id,' ⌯ تم تعطيل المسح التلقائي للميديا')
return false
end 
if text == "تفعيل المسح التلقائي" then        
...
Redis:set(RoBoT.."RoBoT:Status:Del:Media"..msg.chat_id,true)
LuaTele.sendText(msg_chat_id,msg_id,' ⌯ تم تفعيل المسح التلقائي للميديا')
return false
end 
...
if TextMsg == 'الرابط' then
Redis:del(RoBoT.."RoBoT:Status:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"* ⌯ تم تعطيل الرابط *","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(RoBoT.."RoBoT:Status:Welcome"..msg_chat_id) 
...
Redis:del(RoBoT.."RoBoT:Status:Id"..msg_chat_id) 
...
Redis:del(RoBoT.."RoBoT:Status:IdPhoto"..msg_chat_id) 
...
Redis:del(RoBoT.."RoBoT:Status:Reply"..msg_chat_id) 
...
Redis:del(RoBoT.."RoBoT:Status:ReplySudo"..msg_chat_id) 
...
Redis:del(RoBoT.."RoBoT:Status:BanId"..msg_chat_id) 
...
Redis:del(RoBoT.."RoBoT:TwaslBot") 
...
if Controller(msg_chat_id,UserId_Info.id) == 'المبرمج مصطفي' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ⌯ عذرا لا تستطيع حظر عام  "..Controller(msg_chat_id,UserId_Info.id).."  *","md",true)  
end
if Controller(msg_chat_id,UserId_Info.id) == 'المبرمج روبوت' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ⌯ عذرا لا تستطيع حظر عام  "..Controller(msg_chat_id,UserId_Info.id).."  *","md",true)  
end
if Redis:sismember(RoBoT.."RoBoT:BanAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌯ تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(RoBoT.."RoBoT:BanAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(RoBoT.."RoBoT:BanAll:Groups",UserId_Info.id) then
...
Redis:srem(RoBoT.."RoBoT:BanAll:Groups",UserId_Info.id) 
...
if Redis:sismember(RoBoT.."RoBoT:ktmAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌯ تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(RoBoT.."RoBoT:ktmAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(RoBoT.."RoBoT:ktmAll:Groups",UserId_Info.id) then
...
Redis:srem(RoBoT.."RoBoT:ktmAll:Groups",UserId_Info.id) 
...
if not msg.Originators and not Redis:get(RoBoT.."RoBoT:Status:BanId"..msg_chat_id) then
...
if Redis:sismember(RoBoT.."RoBoT:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌯ تم حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(RoBoT.."RoBoT:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
...
if not Redis:sismember(RoBoT.."RoBoT:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌯ تم الغاء حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:srem(RoBoT.."RoBoT:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ⌯ عذرا لا تستطيع كت "..Controller(msg_chat_id,UserId_Info.id).."  *","md",true)  
end
if Redis:sismember(RoBoT.."RoBoT:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌯ تم كتمه في الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(RoBoT.."RoBoT:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(RoBoT.."RoBoT:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌯ تم الغاء كتمه من الجروب ").Reply,"md",true)  
else
Redis:srem(RoBoT.."RoBoT:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌯ تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
end
...
if Controller(msg_chat_id,Message_Reply.sender.user_id) == 'المبرمج مصطفي' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ⌯ عذرا لا تستطيع حظر عام  "..Controller(msg_chat_id,Message_Reply.sender.user_id).."  *","md",true)  
end
if Controller(msg_chat_id,Message_Reply.sender.user_id) == 'المبرمج روبوت' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ⌯ عذرا لا تستطيع حظر عام  "..Controller(msg_chat_id,Message_Reply.sender.user_id).."  *","md",true)  
end
if Redis:sismember(RoBoT.."RoBoT:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(RoBoT.."RoBoT:BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(RoBoT.."RoBoT:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(RoBoT.."RoBoT:BanAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(RoBoT.."RoBoT:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(RoBoT.."RoBoT:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(RoBoT.."RoBoT:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(RoBoT.."RoBoT:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(RoBoT.."RoBoT:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(RoBoT.."RoBoT:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(RoBoT.."RoBoT:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(RoBoT.."RoBoT:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(RoBoT.."RoBoT:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(RoBoT.."RoBoT:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(RoBoT.."RoBoT:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(RoBoT.."RoBoT:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⌯ تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
end
...
if Redis:sismember(RoBoT.."RoBoT:MosTafa:Ahmed"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(RoBoT.."RoBoT:MosTafa:Ahmed"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(RoBoT.."RoBoT:MosTafa:Ahmed"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(RoBoT.."RoBoT:MosTafa:Ahmed"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Controller(msg_chat_id,UserId) == 'المبرمج مصطفي' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ⌯ عذرا لا تستطيع حظر عام  "..Controller(msg_chat_id,UserId).."  *","md",true)  
end
if Controller(msg_chat_id,UserId) == 'المبرمج روبوت' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ⌯ عذرا لا تستطيع حظر عام  "..Controller(msg_chat_id,UserId).."  *","md",true)  
end
if Redis:sismember(RoBoT.."RoBoT:BanAll:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ⌯ تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(RoBoT.."RoBoT:BanAll:Groups",UserId) 
...
if Redis:sismember(RoBoT.."RoBoT:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ⌯ تم حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(RoBoT.."RoBoT:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
...
if not Redis:sismember(RoBoT.."RoBoT:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ⌯ تم الغاء حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:srem(RoBoT.."RoBoT:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(RoBoT.."RoBoT:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ⌯ تم كتمه في الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(RoBoT.."RoBoT:SilentGroup:Group"..msg_chat_id,UserId) 
...
if not Redis:sismember(RoBoT.."RoBoT:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ⌯ تم الغاء كتمه من الجروب ").Reply,"md",true)  
else
Redis:srem(RoBoT.."RoBoT:SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ⌯ تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
end
...
if text == "نزلني" then
if not Redis:get(RoBoT.."RoBoT:Status:remMe"..msg_chat_id) then
...
Rink = 1
elseif Redis:sismember(RoBoT.."RoBoT:DevelopersQ:Groups",msg.sender.user_id)  then
Rink = 2
elseif Redis:sismember(RoBoT.."RoBoT:Developers:Groups",msg.sender.user_id)  then
Rink = 3
elseif Redis:sismember(RoBoT.."RoBoT:TheBasicsQ:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 4
elseif Redis:sismember(RoBoT.."RoBoT:TheBasics:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 5
elseif Redis:sismember(RoBoT.."RoBoT:Originators:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 6
elseif Redis:sismember(RoBoT.."RoBoT:Managers:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 7
elseif Redis:sismember(RoBoT.."RoBoT:Addictive:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 8
elseif Redis:sismember(RoBoT.."RoBoT:Distinguished:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(RoBoT.."RoBoT:Addictive:Group"..msg_chat_id, msg.sender.user_id)
Redis:srem(RoBoT.."RoBoT:Distinguished:Group"..msg_chat_id, msg.sender.user_id)
...
if not Redis:get(RoBoT.."RoBoT:Status:KickMe"..msg_chat_id) then
...
if ban.username ~= "" then
listAdmin = listAdmin.."*"..k.." - @llIlllllllllllII"..Creator.."\n"
else
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(RoBoT.."RoBoT:TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(RoBoT.."RoBoT:Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
if text == "صورتي" then
if Redis:get(RoBoT.."Status:photo"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
local ban = LuaTele.getUser(msg.sender.user_id)
...
local zwgat_list = Redis:smembers(RoBoT..msg_chat_id.."zwgat:")
...
local lonely_list = Redis:smembers(RoBoT..msg_chat_id.."lonely:")
...
local mutlqat_list = Redis:smembers(RoBoT..msg_chat_id.."mutlqat:")
...
local klbklb_list = Redis:smembers(RoBoT..msg_chat_id.."klbklb:")
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(RoBoT.."chadmin"..msg_chat_id),"md",true)  
end
if text == "اضف قناه" then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⌯ هاذا الامر يخص「 '..Controller_Num(7)..' 」* ',"md",true)  
end
Redis:set(RoBoT.."addchannel"..msg.sender.user_id,"on") 
...
if ChannelJoin(msg) == false then
local chinfo = Redis:get(RoBoT.."ch:admin")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = chinfo}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n⌯ عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
Redis:set(RoBoT.."Lock:channell"..msg_chat_id,true) 
...
Redis:set(RoBoT.."RoBoT:Lock:text"..msg_chat_id,true) 
...
Redis:set(RoBoT.."RoBoT:Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(RoBoT.."RoBoT:Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(RoBoT.."RoBoT:Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(RoBoT.."RoBoT:Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(RoBoT.."RoBoT:Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(RoBoT.."lockalllll"..msg_chat_id,"off")
...
Redis:set(RoBoT.."lockalllll"..msg_chat_id,"on")
...
Redis:set(RoBoT.."RoBoT:lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(RoBoT.."RoBoT:Lock:edit"..msg_chat_id,true) 
...
Redis:set(RoBoT.."RoBoT:Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(RoBoT..'RoBoT:'..lock..msg_chat_id,"del")    
end
...
Redis:del(RoBoT.."RoBoT:Lock:AddMempar"..msg_chat_id)  
...
Redis:del(RoBoT.."Lock:channell"..msg_chat_id)  
...
Redis:hset(RoBoT.."Spam:Group:User"..msg_chat_id ,"Num:Spam" ,Num) 
...
Redis:del(RoBoT.."RoBoT:Lock:text"..msg_chat_id)  
...
Redis:del(RoBoT.."RoBoT:Lock:Join"..msg_chat_id)  
...
Redis:del(RoBoT.."RoBoT:Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(RoBoT.."RoBoT:Lock:tagservr"..msg_chat_id)  
...
Redis:del(RoBoT.."RoBoT:lockpin"..msg_chat_id)  
...
Redis:del(RoBoT.."RoBoT:Lock:edit"..msg_chat_id) 
...
Redis:del(RoBoT.."RoBoT:Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(RoBoT..'RoBoT:'..lock..msg_chat_id)    
end
...
Redis:hset(RoBoT.."RoBoT:Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(RoBoT.."RoBoT:Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(RoBoT.."RoBoT:Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(RoBoT.."RoBoT:Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(RoBoT.."RoBoT:Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(RoBoT.."RoBoT:Lock:Link"..msg_chat_id,"del")  
...
Redis:set(RoBoT.."RoBoT:Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(RoBoT.."RoBoT:Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(RoBoT.."RoBoT:Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(RoBoT.."RoBoT:Lock:Link"..msg_chat_id)  
...
Redis:set(RoBoT.."RoBoT:Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(RoBoT.."RoBoT:Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(RoBoT.."RoBoT:Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(RoBoT.."RoBoT:Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(RoBoT.."RoBoT:Lock:User:Name"..msg_chat_id)  
...
Redis:set(RoBoT.."RoBoT:Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(RoBoT.."RoBoT:Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(RoBoT.."RoBoT:Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(RoBoT.."RoBoT:Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(RoBoT.."RoBoT:Lock:hashtak"..msg_chat_id)  
...
Redis:set(RoBoT.."RoBoT:Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(RoBoT.."RoBoT:Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(RoBoT.."RoBoT:Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(RoBoT.."RoBoT:Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:del(RoBoT.."RoBoT:Lock:Cmd"..msg_chat_id)  
...
Redis:set(RoBoT.."RoBoT:Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(RoBoT.."RoBoT:Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(RoBoT.."RoBoT:Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(RoBoT.."RoBoT:Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(RoBoT.."RoBoT:Lock:Photo"..msg_chat_id)  
...
Redis:set(RoBoT.."RoBoT:Lock:Video"..msg_chat_id,"del")  
...
Redis:set(RoBoT.."RoBoT:Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(RoBoT.."RoBoT:Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(RoBoT.."RoBoT:Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(RoBoT.."RoBoT:Lock:Video"..msg_chat_id)  
...
Redis:set(RoBoT.."RoBoT:Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(RoBoT.."RoBoT:Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(RoBoT.."RoBoT:Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(RoBoT.."RoBoT:Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(RoBoT.."RoBoT:Lock:Animation"..msg_chat_id)  
...
Redis:set(RoBoT.."RoBoT:Lock:geam"..msg_chat_id,"del")  
...
Redis:set(RoBoT.."RoBoT:Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(RoBoT.."RoBoT:Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(RoBoT.."RoBoT:Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(RoBoT.."RoBoT:Lock:geam"..msg_chat_id)  
...
Redis:set(RoBoT.."RoBoT:Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(RoBoT.."RoBoT:Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(RoBoT.."RoBoT:Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(RoBoT.."RoBoT:Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(RoBoT.."RoBoT:Lock:Audio"..msg_chat_id)  
...
Redis:set(RoBoT.."RoBoT:Lock:vico"..msg_chat_id,"del")  
...
Redis:set(RoBoT.."RoBoT:Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(RoBoT.."RoBoT:Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(RoBoT.."RoBoT:Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(RoBoT.."RoBoT:Lock:vico"..msg_chat_id)  
...
Redis:set(RoBoT.."RoBoT:Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(RoBoT.."RoBoT:Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(RoBoT.."RoBoT:Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(RoBoT.."RoBoT:Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(RoBoT.."RoBoT:Lock:Keyboard"..msg_chat_id)  
...
Redis:set(RoBoT.."RoBoT:Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(RoBoT.."RoBoT:Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(RoBoT.."RoBoT:Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(RoBoT.."RoBoT:Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(RoBoT.."RoBoT:Lock:Sticker"..msg_chat_id)  
...
Redis:set(RoBoT.."RoBoT:Lock:forward"..msg_chat_id,"del")  
...
Redis:set(RoBoT.."RoBoT:Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(RoBoT.."RoBoT:Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(RoBoT.."RoBoT:Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(RoBoT.."RoBoT:Lock:forward"..msg_chat_id)  
...
Redis:set(RoBoT.."RoBoT:Lock:Document"..msg_chat_id,"del")  
...
Redis:set(RoBoT.."RoBoT:Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(RoBoT.."RoBoT:Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(RoBoT.."RoBoT:Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(RoBoT.."RoBoT:Lock:Document"..msg_chat_id)  
...
Redis:set(RoBoT.."RoBoT:Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(RoBoT.."RoBoT:Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(RoBoT.."RoBoT:Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(RoBoT.."RoBoT:Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(RoBoT.."RoBoT:Lock:Unsupported"..msg_chat_id)  
...
Redis:set(RoBoT.."RoBoT:Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(RoBoT.."RoBoT:Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(RoBoT.."RoBoT:Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(RoBoT.."RoBoT:Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(RoBoT.."RoBoT:Lock:Markdaun"..msg_chat_id)  
...
Redis:set(RoBoT.."RoBoT:Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(RoBoT.."RoBoT:Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(RoBoT.."RoBoT:Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(RoBoT.."RoBoT:Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(RoBoT.."RoBoT:Lock:Contact"..msg_chat_id)  
...
Redis:set(RoBoT.."RoBoT:Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(RoBoT.."RoBoT:Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(RoBoT.."RoBoT:Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(RoBoT.."RoBoT:Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(RoBoT.."RoBoT:Lock:Spam"..msg_chat_id)  
...
Redis:set(RoBoT.."RoBoT:Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(RoBoT.."RoBoT:Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(RoBoT.."RoBoT:Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(RoBoT.."RoBoT:Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(RoBoT.."RoBoT:Lock:Inlen"..msg_chat_id)  
...
Redis:setex(RoBoT.."RoBoT:Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local GetLink = Redis:get(RoBoT.."RoBoT:Group:Link"..msg_chat_id) 
if GetLink then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
{{text =Get_Chat.title, url = GetLink}, },}}
return LuaTele.sendText(msg_chat_id, msg_id, " \n["..Get_Chat.title.. ']('..GetLink..')', 'md', true, false, false, false, reply_markup)
...
Redis:setex(RoBoT.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
if not Redis:get(RoBoT.."RoBoT:Status:Welcome"..msg_chat_id) then
...
Redis:del(RoBoT.."RoBoT:Welcome:Group"..msg_chat_id) 
...
Redis:setex(RoBoT.."RoBoT:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(RoBoT.."RoBoT:Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id," ⌯ تم ازالة قوانين الجروب","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(RoBoT.."RoBoT:Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(RoBoT.."RoBoT:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(RoBoT.."RoBoT:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(RoBoT.."RoBoT:List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(RoBoT.."RoBoT:Filter:Group:"..v..msg_chat_id)  
Redis:srem(RoBoT.."RoBoT:List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(RoBoT.."RoBoT:Filter:Group:"..v..msg_chat_id)   
...
Redis:set(RoBoT..'RoBoT:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(RoBoT..'RoBoT:FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ⌯ ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
...
Redis:set(RoBoT.."RoBoT:All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(RoBoT.."RoBoT:All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(RoBoT.."RoBoT:All:Command:List:Group")
for k,v in pairs(list) do
Redis:del(RoBoT.."RoBoT:All:Get:Reides:Commands:Group"..v)
Redis:del(RoBoT.."RoBoT:All:Command:List:Group")
end
...
for k,v in pairs(list) do
Commands = Redis:get(RoBoT.."RoBoT:All:Get:Reides:Commands:Group"..v)
if Commands then 
...
Redis:set(RoBoT.."RoBoT:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id," ⌯ الان ارسل لي الامر القديم ...","md",true)
end
...
Redis:set(RoBoT.."RoBoT:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id," ⌯ ارسل الان الامر الذي قمت بوضعه مكان الامر القديم","md",true)
end
...
local list = Redis:smembers(RoBoT.."RoBoT:Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(RoBoT.."RoBoT:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(RoBoT.."RoBoT:Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(RoBoT.."RoBoT:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
Command = Command..""..k..": ("..v..") ⇦ {"..Commands.."}\n"
else
Command = Command..""..k..": ("..v..") \n"
...
if Redis:get(RoBoT.."RoBoT:Status:Link"..msg.chat_id) then
Statuslink = '【 ✅ 】' else Statuslink = '【 ❌ 】'
end
if Redis:get(RoBoT.."RoBoT:Status:Welcome"..msg.chat_id) then
StatusWelcome = '【 ✅ 】' else StatusWelcome = '【 ❌ 】'
end
if Redis:get(RoBoT.."RoBoT:Status:Id"..msg.chat_id) then
StatusId = '【 ✅ 】' else StatusId = '【 ❌ 】'
end
if Redis:get(RoBoT.."RoBoT:Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '【 ✅ 】' else StatusIdPhoto = '【 ❌ 】'
end
if Redis:get(RoBoT.."RoBoT:Status:Reply"..msg.chat_id) then
StatusReply = '【 ✅ 】' else StatusReply = '【 ❌ 】'
end
if Redis:get(RoBoT.."RoBoT:Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '【 ✅ 】' else StatusReplySudo = '【 ❌ 】'
end
if Redis:get(RoBoT.."RoBoT:Status:BanId"..msg.chat_id)  then
StatusBanId = '【 ✅ 】' else StatusBanId = '【 ❌ 】'
end
if Redis:get(RoBoT.."RoBoT:Status:SetId"..msg.chat_id) then
StatusSetId = '【 ✅ 】' else StatusSetId = '【 ❌ 】'
end
if Redis:get(RoBoT.."RoBoT:Status:Games"..msg.chat_id) then
StatusGames = '【 ✅ 】' else StatusGames = '【 ❌ 】'
end
if Redis:get(RoBoT.."RoBoT:Status:KickMe"..msg.chat_id) then
Statuskickme = '【 ✅ 】' else Statuskickme = '【 ❌ 】'
end
if Redis:get(RoBoT.."RoBoT:Status:AddMe"..msg.chat_id) then
...
data = {
{
{text = '  𝑺𝑶𝑼𝑹𝑪𝑬 𝑺𝑨𝑺𝑨  ', url = 't.me/llIlllllllllllII'}, 
},
}
}
...
Rink = 1
elseif Redis:sismember(RoBoT.."RoBoT:Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(RoBoT.."RoBoT:TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 3
elseif Redis:sismember(RoBoT.."RoBoT:Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(RoBoT.."RoBoT:Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(RoBoT.."RoBoT:Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(RoBoT.."RoBoT:Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
else
Rink = 8
end
...
Rink = 1
elseif Redis:sismember(RoBoT.."RoBoT:Developers:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(RoBoT.."RoBoT:TheBasics:Group"..msg_chat_id, UserId_Info.id) then
Rink = 3
elseif Redis:sismember(RoBoT.."RoBoT:Originators:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(RoBoT.."RoBoT:Managers:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(RoBoT.."RoBoT:Addictive:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(RoBoT.."RoBoT:Distinguished:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
else
Rink = 8
end
...
Redis:del(RoBoT..'RoBoT:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'*⌯ تم مسح جميع رسائلك *',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(RoBoT..'RoBoT:Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'*⌯ تم مسح جميع تعديلاتك *',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(RoBoT..'RoBoT:Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'*⌯ تم مسح جميع جهاتك المضافه *',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'*⌯ عدد رسائلك هنا ⇦ '..(Redis:get(RoBoT..'RoBoT:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'*⌯ عدد التعديلات هنا ⇦ '..(Redis:get(RoBoT..'RoBoT:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'*⌯ عدد جهاتك يبشا ⇦ '..(Redis:get(RoBoT.."RoBoT:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 1)..'*',"md",true)  
...
Redis:setex(RoBoT.."RoBoT:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
 ⌯ ارسل الان النص
 ⌯ يمكنك اضافه :
...
Redis:del(RoBoT.."RoBoT:Set:Id:Groups")
...
Redis:setex(RoBoT.."RoBoT:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
 ⌯ ارسل الان النص
 ⌯ يمكنك اضافه :
 ⌯ `#username` » اسم المستخدم
...
Redis:del(RoBoT.."RoBoT:Set:Id:Group"..msg.chat_id)
...
Redis:del(RoBoT.."RoBoT:DevelopersQ:Groups") 
...
Redis:del(RoBoT.."RoBoT:Developers:Groups") 
...
Redis:del(RoBoT.."RoBoT:TheBasics:Group"..msg_chat_id) 
...
Redis:del(RoBoT.."RoBoT:Originators:Group"..msg_chat_id) 
...
Redis:del(RoBoT.."RoBoT:Managers:Group"..msg_chat_id) 
...
Redis:del(RoBoT.."RoBoT:Addictive:Group"..msg_chat_id) 
...
Redis:del(RoBoT.."RoBoT:Distinguished:Group"..msg_chat_id) 
...
Redis:del(RoBoT.."RoBoT:BanAll:Groups") 
...
Redis:del(RoBoT.."RoBoT:ktmAll:Groups") 
...
Redis:del(RoBoT.."RoBoT:BanGroup:Group"..msg_chat_id) 
...
local Info_Members = Redis:smembers(RoBoT.."RoBoT:MosTafa:Ahmed"..msg_chat_id) 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id," ⌯ لا يوجد مطردين في الجروب ","md",true)  
end
Redis:del(RoBoT.."RoBoT:MosTafa:Ahmed"..msg_chat_id) 
...
Redis:del(RoBoT.."RoBoT:SilentGroup:Group"..msg_chat_id) 
...
local list = Redis:smembers(RoBoT.."RoBoT:List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(RoBoT.."RoBoT:Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(RoBoT.."RoBoT:Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(RoBoT.."RoBoT:Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(RoBoT.."RoBoT:Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(RoBoT.."RoBoT:Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(RoBoT.."RoBoT:Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(RoBoT.."RoBoT:Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(RoBoT.."RoBoT:Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(RoBoT.."RoBoT:Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(RoBoT.."RoBoT:List:Manager"..msg_chat_id)
end
...
text = " ⌯ قائمه الردود ⇧⇩\n༺┉┉┉⊶﴾ 𝑺𝑶𝑼𝑹𝑪𝑬 𝑺𝑨𝑺𝑨 ﴿⊷┉┉┉༻\n"
for k,v in pairs(list) do
if Redis:get(RoBoT.."RoBoT:Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(RoBoT.."RoBoT:Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(RoBoT.."RoBoT:Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(RoBoT.."RoBoT:Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(RoBoT.."RoBoT:Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(RoBoT.."RoBoT:Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(RoBoT.."RoBoT:Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف • "
elseif Redis:get(RoBoT.."RoBoT:Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(RoBoT.."RoBoT:Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(RoBoT.."RoBoT:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(RoBoT.."RoBoT:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
...
local list = Redis:smembers(RoBoT.."RoBoT:List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(RoBoT.."RoBoT:Add:Rd:Sudo:Gif"..v)   
Redis:del(RoBoT.."RoBoT:Add:Rd:Sudo:vico"..v)   
Redis:del(RoBoT.."RoBoT:Add:Rd:Sudo:stekr"..v)     
Redis:del(RoBoT.."RoBoT:Add:Rd:Sudo:Text"..v)   
Redis:del(RoBoT.."RoBoT:Add:Rd:Sudo:Photo"..v)
Redis:del(RoBoT.."RoBoT:Add:Rd:Sudo:Video"..v)
Redis:del(RoBoT.."RoBoT:Add:Rd:Sudo:File"..v)
Redis:del(RoBoT.."RoBoT:Add:Rd:Sudo:Audio"..v)
Redis:del(RoBoT.."RoBoT:Add:Rd:Sudo:video_note"..v)
Redis:del(RoBoT.."RoBoT:List:Rd:Sudo")
end
...
text = "\n⌯ قائمة الردود العامه ⇧⇩\n༺┉┉┉⊶﴾ 𝑺𝑶𝑼𝑹𝑪𝑬 𝑺𝑨𝑺𝑨 ﴿⊷┉┉┉༻\n"
for k,v in pairs(list) do
if Redis:get(RoBoT.."RoBoT:Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(RoBoT.."RoBoT:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(RoBoT.."RoBoT:Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(RoBoT.."RoBoT:Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(RoBoT.."RoBoT:Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(RoBoT.."RoBoT:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(RoBoT.."RoBoT:Add:Rd:Sudo:File"..v) then
db = "ملف • "
elseif Redis:get(RoBoT.."RoBoT:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(RoBoT.."RoBoT:Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(RoBoT.."RoBoT:Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(RoBoT.."Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
...
if not msg.ControllerBot and not Redis:set(RoBoT.."SendBcBot") then
...
Redis:setex(RoBoT.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[*
...
Redis:setex(RoBoT.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[*
...
Redis:setex(RoBoT.."RoBoT:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
...
Redis:setex(RoBoT.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(RoBoT.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(RoBoT..'RoBoT:GetTexting:DevRoBoT'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(RoBoT..'RoBoT:Texting:DevRoBoT')
...
local list = Redis:smembers(RoBoT.."cleaner"..msg_chat_id)
if #list == 0 then 
...
Redis:del(RoBoT.."cleaner"..msg_chat_id)
...
if Redis:get(RoBoT.."zhrfa"..msg.sender.user_id) == "sendzh" then
...
LuaTele.sendText(msg_chat_id,msg_id,t,"md",true) 
Redis:del(RoBoT.."zhrfa"..msg.sender.user_id) 
end

if text == 'جمالي' or text == 'نسبه جمالي' then
if not Redis:get(RoBoT.."Status:gamle"..msg_chat_id) then
return false
end
local ban = LuaTele.getUser(msg.sender.user_id)
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
local TestText = "  ❲ Developers RoBoT  ❳\n— — — — — — — — —\n ⌯*Dev Name* :  [".. ban.first_name.."](tg://user?id="..Sudo_Id..")\n⌯ *Dev Bio* : [❲ "..Bio.." ❳]"
local msg_id = msg.id/2097152/0.5 
...
if text == '453435453453 ' or text == '53453455465345' or text == '45656456645654456' or text == '  56565656456455  ' then    
...
Creat = " Developers RoBoT\n"
end
local photo = LuaTele.getUserProfilePhotos(UserId_Info.id)
if photo.total_count > 0 then
local TestText = " ᴅᴇᴠ•ᴛɪᴍᴏ \n— — — — — — — — —\n ⌯*Dev Name* :  [".. ban.first_name.."](tg://user?id="..UserId_Info.id..")\n⌯ *Dev Bio* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = ' ᴅᴇᴠ•ᴛɪᴍᴏ ', url = "https://t.me/tt_t_4"}
},
{
{text = ' ɢʀᴏ𝗎ᴘ ', url = "https://t.me/llIlllllllllllII"},{text = ' ᴄʜᴀɴɴᴇʟ ', url = "https://t.me/llIlllllllllllII"}
},
{
{text = '᥇ ꪮ𝓽   ꪜ𝓲𝘬𝓲 ꪀ ᧁ',url="t.me/O_T_T_bot"}
},
}
local msg_id = msg.id/2097152/0.5 
 https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
if text == 'المبرمج مصطفي' or text == 'مصطفي' or text == 'مطور السورس' or text == '  المبرمج مصطفي  ' then    
local UserId_Info = LuaTele.searchPublicChat("NO3_NAME")
if UserId_Info.id then
local  ban = LuaTele.getUser(UserId_Info.id)
local  bain = LuaTele.getUserFullInfo(UserId_Info.id)
if  bain.bio then
...
local photo = LuaTele.getUserProfilePhotos(UserId_Info.id)
if photo.total_count > 0 then
local TestText = " ᴅᴇᴠ•ѕᴇᴢʀ \n— — — — — — — — —\n ⌯*Dev Name* :  [".. ban.first_name.."](tg://user?id="..UserId_Info.id..")\n⌯ *Dev Bio* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = ' ᴅᴇᴠ•ѕᴇᴢʀ ', url = "https://t.me/NO3_NAME"}
},
{
{text = ' ɢʀᴏ𝗎ᴘ ', url = "https://t.me/llIlllllllllllII"},{text = ' ᴄʜᴀɴɴᴇʟ ', url = "https://t.me/llIlllllllllllII"}
},
...
if text == 'المبرمج روبوت' or text == 'روبوت' or text == 'اين روبوت' or text == '  المبرمج روبوت  ' then    
local UserId_Info = LuaTele.searchPublicChat("O_T_T")
if UserId_Info.id then
local  ban = LuaTele.getUser(UserId_Info.id)
local  bain = LuaTele.getUserFullInfo(UserId_Info.id)
if  bain.bio then
...
local photo = LuaTele.getUserProfilePhotos(UserId_Info.id)
if photo.total_count > 0 then
local TestText = " 𝙰𝚂𝙰𝙻𝙸𝚈𝙰 𝙴𝙶𝚈𝙿𝚃 \n— — — — — — — — —\n ⌯*Dev Name* :  [".. ban.first_name.."](tg://user?id="..UserId_Info.id..")\n⌯ *Dev Bio* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = ' 𝙰𝚂𝙰𝙻𝙸𝚈𝙰 𝙴𝙶𝚈𝙿𝚃 ', url = "https://t.me/O_T_T"}
},
{
{text = ' ɢʀᴏ𝗎ᴘ ', url = "https://t.me/Tem_Asaliya"},{text = ' ᴄʜᴀɴɴᴇʟ ', url = "https://t.me/llIlllllllllllII"}
},
}
local msg_id = msg.id/2097152/0.5 
 https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
if text == 'م2424242ور 42' or text == '242424242242' or text == '2424242 24' or text == '  5454545 54545  ' then    
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
local bains = LuaTele.getUser(msg.sender.user_id)
if bains.first_name then
...
if text == 'المبرمج روبوت' or text == 'روبوت' or text == 'عسلية' or text == '  المبرمج روبوت  ' then    
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
local bains = LuaTele.getUser(msg.sender.user_id)
if bains.first_name then
...
if Redis:get(RoBoT.."Status:kool"..msg.chat_id) then
...
[⚙️╠ 𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 𝗦𝗢𝗨𝗥𝗖𝗘 𝗩𝗜𝗞𝗜𝗡𝗚](http://t.me/llIlllllllllllII)

╠•ـــــــــــــــــــــــــــــــــــــــــ

[🌐╠ 𝗧𝗛𝗘 𝗕𝗘𝗦𝗧 𝗦𝗢𝗨𝗥𝗖𝗘 𝗧𝗘𝗟𝗘𝗚𝗥𝗔𝗠](http://t.me/llIlllllllllllII)

╠•ـــــــــــــــــــــــــــــــــــــــــ

[🎊╠ 𝗙𝗢𝗟𝗟𝗢𝗪 𝗧𝗛𝗘 𝗕𝗨𝗧𝗧𝗢𝗡𝗦  𝗕𝗘𝗟𝗟𝗢𝗪](http://t.me/llIlllllllllllII)
...
{
{text = ' 𝚂𝙴𝚉𝚁 ', url = "https://t.me/NO3_NAME"}
},
{
{text = ' 𝙰𝚂𝙰𝙻𝙸𝚈𝙰 𝙴𝙶𝚈𝙿𝚃 ', url = "https://t.me/O_T_T"}
},
{
{text = ' ꪮꪊ𝘳ᥴꫀ ꪜ𝓲𝘬𝓲ꪀᧁ ', url = "https://t.me/llIlllllllllllII"}
},
{
{text = 'اضف البوت لمجموعتك ✅', url = 't.me/'..UserBot..'?startgroup=new'},
},
...
{
{text = ' ʙᴏᴛ ', url = "https://t.me/hazf_RoBoT_bot"}
},
{
{text = 'اضف البوت لمجموعتك ✅', url = 't.me/'..UserBot..'?startgroup=new'},
},
...
{
{text = ' ᴄʜᴀɴɴᴇʟ ',url="t.me/llIlllllllllllII"}
},
{
{text = 'اضف البوت لمجموعتك ✅', url = 't.me/'..UserBot..'?startgroup=new'},
},
...
local Name = ' ᭙ ꫀꪶ ᥴ ꪮ ꪑ ꫀ 𝓽 ꪮ 𝘴 ꪮꪊ𝘳 ᥴ ꫀ  ꪜ𝓲𝘬𝓲 ꪀ ᧁ '
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ' صـاحـب الـتـيـم ', url = "https://t.me/O_T_T"}
},
{
{text = ' بـوت الـتـيـم ', url = "https://t.me/O_T_T_bot"}
},
{
{text = ' جـروب التـيـم ', url = "https://t.me/llIlllllllllllII"},{text = ' قـنـاه الـتـيـم ', url = "https://t.me/rmdan_karim"}
},
{
{text = 'تيم سيلفآ آصح ـآب آلتلي 🎌✘⃟๏͈͈͈͈͈͈͈', url = "https://t.me/llIlllllllllllII"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
{
{text = ' 𝑺𝑶𝑼𝑹𝑪𝑬 𝑺𝑨𝑺𝑨  ', url = 't.me/omar_goo_noor'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[*
...
data = {
{
{text = '  تفعيل ردود السورس  ', data = msg.sender.user_id..'/jeka_alone'},
},
{
{text = '  تعطيل ردود السورس  ', data = msg.sender.user_id..'/mostaf_sasa'},
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[*
...
if tonumber(Message_Reply.sender.user_id) == tonumber(RoBoT) then
return LuaTele.sendText(msg_chat_id,msg_id,"*شوفلك كلبه غير البوت يبنوسخه 😒*","md",true)  
end
if Redis:sismember(RoBoT..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
local rd_mtzwga = {
...
if Redis:sismember(RoBoT..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) then 
Redis:srem(RoBoT..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id)
end
Redis:sadd(RoBoT..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) 
...
if Redis:sismember(RoBoT..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
Redis:srem(RoBoT..msg_chat_id.."zwgat:",Message_Reply.sender.user_id)
Redis:sadd(RoBoT..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) 
local rd_tmtlaq = {
...
if Redis:sismember(RoBoT..msg_chat_id.."lonely:",Message_Reply.sender.user_id) then
...
Redis:sadd(RoBoT..msg_chat_id.."lonely:",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,rd_zwag[math.random(#rd_zwag)]).Reply,"md",true)  
end
end
...
if Redis:sismember(RoBoT..msg_chat_id.."lonely:",Message_Reply.sender.user_id) then
Redis:srem(RoBoT..msg_chat_id.."lonely:",Message_Reply.sender.user_id)
Redis:sadd(RoBoT..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) 
...
if Redis:sismember(RoBoT..msg_chat_id.."klbklb:",Message_Reply.sender.user_id) then
...
Redis:sadd(RoBoT..msg_chat_id.."klbklb:",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,rd_zwag[math.random(#rd_zwag)]).Reply,"md",true)  
end
end
...
if Redis:sismember(RoBoT..msg_chat_id.."klbklb:",Message_Reply.sender.user_id) then
Redis:srem(RoBoT..msg_chat_id.."klbklb:",Message_Reply.sender.user_id)
Redis:sadd(RoBoT..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) 
...
if not Redis:get(RoBoT.."RoBoT:Sasa:Jeka"..msg_chat_id) then
...
Redis:setex(RoBoT.."RoBoT:Change:RoBoT:Name:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(RoBoT.."RoBoT:Name:Bot") 
...
local NamesBot = (Redis:get(RoBoT.."RoBoT:Name:Bot") or "فايكينج")
local BotName = {
...
keyboard.inline_keyboard = {
{
{text = NamesBots, url = 't.me/CH_RoBoT'}, 
},
{
{text =first_name, url = "https://t.me/llIlllllllllllII"}
},
...
if text == (Redis:get(RoBoT.."RoBoT:Name:Bot") or "فايكينج") then
local photo = LuaTele.getUserProfilePhotos(RoBoT)
local UserInfo = LuaTele.getUser(RoBoT)
local user_info = LuaTele.getUser(msg.sender.user_id)
local first_name = user_info.first_name
...
if not msg.ControllerBot and not Redis:set(RoBoT.."RoBoT:LeftBot") then
...
x = x + 1
Redis:srem(RoBoT..'RoBoT:Num:User:Pv',v)
end
end
if x ~= 0 then
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,RoBoT)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'* ⌯ البوت عظو في الجروب سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
Redis:srem(RoBoT..'RoBoT:ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(RoBoT..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(RoBoT..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(RoBoT..'RoBoT:ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(RoBoT.."RoBoT:Game:Smile"..msg.chat_id,SM)
...
Redis:set(RoBoT.."RoBoT:Game:Monotonous"..msg.chat_id,name)
...
Redis:set(RoBoT.."RoBoT:Game:Riddles"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(RoBoT.."RoBoT:Status:Games"..msg.chat_id) then
Redis:del(RoBoT.."RoBoT:Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(RoBoT.."RoBoT:Game:Meaningof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(RoBoT.."RoBoT:Status:Games"..msg.chat_id) then
Redis:del(RoBoT.."RoBoT:Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(RoBoT.."RoBoT:Game:Reflection"..msg.chat_id,name)
...
Redis:set(RoBoT.."RoBoT:Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(RoBoT.."RoBoT:Game:Difference"..msg.chat_id,name)
...
Redis:set(RoBoT.."RoBoT:Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(RoBoT.."RoBoT:Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(RoBoT.."RoBoT:Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(RoBoT.."RoBoT:Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(RoBoT.."RoBoT:Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(RoBoT.."RoBoT:Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(RoBoT.."RoBoT:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(RoBoT.."RoBoT:Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(RoBoT.."RoBoT:Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(RoBoT.."RoBoT:Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(RoBoT.."RoBoT:Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(RoBoT.."RoBoT:Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(RoBoT.."RoBoT:Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(RoBoT.."RoBoT:Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(RoBoT.."RoBoT:Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
return LuaTele.sendText(msg_chat_id,msg_id,[[*
...
if text == '/start' then
local photo = LuaTele.getUserProfilePhotos(RoBoT)
local ban = LuaTele.getUser(RoBoT)
local bain = LuaTele.getUser(msg.sender.user_id)
Redis:sadd(RoBoT..'Num:User:Pv',msg.sender.user_id)  
if not msg.ControllerBot then
if not Redis:get(RoBoT.."Start:Bot") then
...
local CmdStart = '*\n 🤖 ╔•ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ  ʙᴏᴛ '..(Redis:get(RoBoT.."RoBoT:Name:Bot") or "فايكينج")..
'\n 👻╠•ᴛʜᴇ ʙᴇѕᴛ ʙᴏᴛ ᴛᴇʟᴇɢʀᴀᴍ'..
'\n ♻️╠•𝑺𝑶𝑼𝑹𝑪𝑬 𝑺𝑨𝑺𝑨 ᴛʜɪѕ ɢᴏᴏᴅ ...'..
'\n 👁╠•ᴘʟᴀʏ ʙᴏᴛ ʀᴏᴏʟ ᴀᴅᴍɪɴ'..
'\n 🦸🏻‍♂️╚•ᴅᴇᴠ ʙᴏᴛ =   @'..UserSudo..'  *'
if photo.total_count > 0 then
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ' 𝑀𝑂𝑆𝑇𝐴𝐹𝐴 ', url = "https://t.me/NO3_NAME"},{text = ' 𝑌𝑂𝑈𝑆𝑆𝐸𝐹', url = "https://t.me/O_T_T"}
},
{
{text = ' عـايز سـورس ', url = "https://t.me/llIlllllllllllII"}
},
{
{text = '  قـنـاه الـسـورس  ', url = 't.me/llIlllllllllllII'}, 
},
{
{text = 'اضف البوت لمجموعتك ✅', url = 't.me/'..UserBot..'?startgroup=new'}, 
},
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(RoBoT.."Start:Bot"),"md",false, false, false, false, reply_markup)
end
end
...
data = {
{
{text = '  مطور السورس  ',type = 'text'},{text = '  المبرمج مصطفي  ',type = 'text'}
},
{
{text = '  المبرمج روبوت  ',type = 'text'},
},
{
...
local TestText = "  ❲  ᴅᴇᴠ  ❳\n༺┉┉┉⊶﴾ 𝑺𝑶𝑼𝑹𝑪𝑬 𝑺𝑨𝑺𝑨 ﴿⊷┉┉┉༻n ⌯*Dev Name* :  [".. ban.first_name.."](tg://user?id="..Sudo_Id..")\n⌯ *Dev Bio* : [❲ "..Bio.." ❳]"
local msg_id = msg.id/2097152/0.5 
 https.request("https://api.telegram.org/bot"..Token..'/sendMessage?chat_id=' .. msg.chat_id .. '&text=' .. URL.escape(TestText).."&reply_to_message_id="..msg_id.."&parse_mode=markdown")
end
end
 
if text == '  مطور السورس  ' or text == 'عسكري' or text == '1234535' or text == 'عسكري تلي' then  
...
keyboardd.inline_keyboard = {
{
{text = ' 𝙴𝙻3𝚂𝙺𝙴𝚁𝙰 ', url = "https://t.me/Ahmeaaa11"}
},
{
{text = ' ɢʀᴏ𝗎ᴘ ', url = "https://t.me/llIlllllllllllII"},{text = ' ᴄʜᴀɴɴᴇʟ ', url = "https://t.me/llIlllllllllllII"}
},
...
if text == '  المبرمج مصطفي  ' or text == 'مصطفي' or text == 'مططور' or text == 'مطور السورس' then  
local UserId_Info = LuaTele.searchPublicChat("NO3_NAME")
if UserId_Info.id then
local  ban = LuaTele.getUser(UserId_Info.id)
local  bain = LuaTele.getUserFullInfo(Sudo_Id)
...
keyboardd.inline_keyboard = {
{
{text = '𝑀𝑂𝑆𝑇𝐴𝐹𝐴  ', url = "https://t.me/NO3_NAME"}
},
{
{text = ' ɢʀᴏ𝗎ᴘ ', url = "https://t.me/llIlllllllllllII"},{text = ' ᴄʜᴀɴɴᴇʟ ', url = "https://t.me/llIlllllllllllII"}
},
...
if text == '  المبرمج روبوت  ' or text == 'روبوت' or text == 'Asaliya' or text == 'عسلية' then  
local UserId_Info = LuaTele.searchPublicChat("O_T_T")
if UserId_Info.id then
local  ban = LuaTele.getUser(UserId_Info.id)
local  bain = LuaTele.getUserFullInfo(Sudo_Id)
...
{
{text = ' �𝙻3𝚂𝙺��� ', url = "https://t.me/Ahmeaaa11"},{text = ' 𝚂𝙴𝚉𝚁 ', url = "https://t.me/NO3_NAME"}
},
{
{text = ' 𝙰𝚂𝙰𝙻𝙸𝚈𝙰 𝙴𝙶𝚈𝙿𝚃 ', url = "https://t.me/O_T_T"}
},
...
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
elseif text == 'صاصا' or text == 'سورس صاصا' or text == 'سورس' or text == 'السورس' then
photo = "https://t.me/V_I_K_I_N_G_2/9"
local Name = ' ᭙ ꫀꪶ ᥴ ꪮ ꪑ ꫀ 𝓽 ꪮ 𝘴 ꪮꪊ𝘳 ᥴ ꫀ  ꪜ𝓲𝘬𝓲 ꪀ ᧁ '
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ' قناه السورس', url = "https://t.me/llIlllllllllllII"}
},
{
{text = ' مطور السورس ', url = "https://t.me/O_T_T"},{text = 'مبرمج السورس ', url = "https://t.me/NO3_NAME"}
},
{
{text = ' 𝑺𝑶𝑼𝑹𝑪𝑬 𝑺𝑨𝑺𝑨', url = "https://t.me/llIlllllllllllII"}
},
...
keyboard.inline_keyboard = {
{
{text = NamesBots, url = 't.me/llIlllllllllllII'}, 
},
{
{text =first_name, url = "https://t.me/llIlllllllllllII"}
},
...
Redis:setex(RoBoT.."RoBoT:Change:Start:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(RoBoT.."RoBoT:Start:Bot") 
...
Redis:set(RoBoT.."RoBoT:Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
return LuaTele.sendText(msg_chat_id,msg_id," ⌯ ارسل الان الكلمه لحذفها من الردود العامه","md",true)  
end
if text=='  اذاعه خاص  ' then 
if not msg.ControllerBot then 
...
Redis:setex(RoBoT.."Bc:Grops:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[*
⌯ ارسل اذاعتك لتثبيت في الجروبات
⌯ للخروج من الامر ارسل الغاء 
*]],"md",true)  
...
if not msg.ControllerBot then
if Redis:get(RoBoT.."RoBoT:TwaslBot") and not Redis:sismember(RoBoT.."RoBoT:BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(RoBoT.."RoBoT:Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(RoBoT.."RoBoT:Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(RoBoT..'RoBoT:BaN:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,' ⌯ تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(RoBoT..'RoBoT:BaN:In:Tuasl',Info_User)  
...
Redis:srem(RoBoT.."RoBoT:ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(RoBoT..'*'..'-100'..data.supergroup.id..'*')
Redis:del(RoBoT.."RoBoT:List:Manager"..'-100'..data.supergroup.id)
Redis:del(RoBoT.."RoBoT:Command:List:Group"..'-100'..data.supergroup.id)
for i = 1, #keys do 
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(RoBoT.."RoBoT:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(RoBoT.."RoBoT:PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(RoBoT.."RoBoT:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(RoBoT.."RoBoT:PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(RoBoT.."RoBoT:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(RoBoT.."RoBoT:PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(RoBoT.."RoBoT:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(RoBoT.."RoBoT:PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(RoBoT.."RoBoT:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(RoBoT.."RoBoT:PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(RoBoT.."RoBoT:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(RoBoT.."RoBoT:PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(RoBoT.."RoBoT:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(RoBoT.."RoBoT:PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(RoBoT.."RoBoT:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(RoBoT.."RoBoT:PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(RoBoT.."RoBoT:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(RoBoT.."RoBoT:PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(RoBoT.."RoBoT:Lock:tagservr"..data.message.chat_id) then
LuaTele.deleteMessages(data.message.chat_id,{[1]= data.message.id})
end
end 
if tonumber(data.message.sender.user_id) == tonumber(RoBoT) then
return false
end
if data.message.content.luatele == "messageChatJoinByLink" and Redis:get(RoBoT..'RoBoT:Status:joinet'..data.message.chat_id) == 'true' then
    local reply_markup = LuaTele.replyMarkup{
    type = 'inline',
    data = {
    {
...
if Message_Edit.sender.user_id == RoBoT then
print('This is Edit for Bot')
return false
end
File_Bot_Run(Message_Edit,Message_Edit)
Redis:incr(RoBoT..'RoBoT:Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(RoBoT.."RoBoT:Lock:edit"..data.chat_id) then
...
Redis:del(RoBoT.."RoBoT:Redis:Id:Group"..ChatId..""..IdUser) 
Redis:del(RoBoT.."RoBoT1:Set:Rd"..IdUser..":"..ChatId)
Redis:del(RoBoT.."RoBoT:Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(RoBoT.."RoBoT:Set:Rd"..IdUser..":"..ChatId)
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(RoBoT.."RoBoT1:Set:Rd"..IdUser..":"..ChatId, "true")
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(RoBoT.."RoBoT:Set:Manager:rd"..IdUser..":"..ChatId,"true")
LuaTele.editMessageText(ChatId,Msg_id,"•  ارسل لي الرد الان", 'md', true)
end
end
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(RoBoT.."RoBoT:Set:Rd"..IdUser..":"..ChatId,true)
LuaTele.editMessageText(ChatId,Msg_id,"•  ارسل لي الرد الان", 'md', true)
end
end
...
Redis:incrby(RoBoT.."RoBoT:Num:Add:Games"..ChatId..IdUser, 1)  
...
{
{text = '  اوامر المطور الاساسي  ', data = IdUser..'/helpo3'}, {text = '  القائمه الرئيسيه  ', data = IdUser..'/helpall'}, 
},
{
{text = '  𝑺𝑶𝑼𝑹𝑪𝑬 𝑺𝑨𝑺𝑨  ', url = 't.me/llIlllllllllllII'}, 
},
...
Redis:set(RoBoT.."zhrfa"..IdUser,"sendzh") 
end 
if Text == '/leftz@' then
LuaTele.editMessageText(ChatId,Msg_id,"*⌯ ارسل الكلمه لزخرفتها عربي او انجلش*","md",true) 
Redis:set(RoBoT.."zhrfa"..IdUser,"sendzh") 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(RoBoT.."RoBoT:Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(RoBoT.."RoBoT:Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(RoBoT.."RoBoT:Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(RoBoT.."RoBoT:Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RoBoT.."RoBoT:Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RoBoT.."RoBoT:Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RoBoT.."RoBoT:Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RoBoT.."RoBoT:Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RoBoT.."RoBoT:Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RoBoT.."RoBoT:Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RoBoT.."RoBoT:Sasa:Jeka"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RoBoT.."RoBoT:Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RoBoT.."RoBoT:Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RoBoT.."RoBoT:Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RoBoT.."RoBoT:Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Sasa:Jeka"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(RoBoT.."RoBoT:Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(RoBoT.."RoBoT:TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(RoBoT.."RoBoT:Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(RoBoT.."RoBoT:Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(RoBoT..'RoBoT:'..lock..UserId[2],"del")    
end
...
Redis:srem(RoBoT.."RoBoT:SilentGroup:Group"..ChatId,listYt[2]) 
Redis:srem(RoBoT.."RoBoT:BanGroup:Group"..ChatId,listYt[2]) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RoBoT.."RoBoT:Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RoBoT.."RoBoT:Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RoBoT.."RoBoT:Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RoBoT.."RoBoT:Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RoBoT.."RoBoT:Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RoBoT.."RoBoT:Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RoBoT.."RoBoT:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RoBoT.."RoBoT:Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RoBoT.."RoBoT:Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RoBoT.."RoBoT:Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RoBoT.."RoBoT:Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RoBoT.."RoBoT:Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RoBoT.."RoBoT:Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RoBoT.."RoBoT:Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RoBoT.."RoBoT:Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RoBoT.."RoBoT:Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RoBoT.."RoBoT:Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RoBoT.."RoBoT:Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RoBoT.."RoBoT:Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RoBoT.."RoBoT:lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RoBoT.."RoBoT:Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RoBoT.."RoBoT:Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RoBoT.."RoBoT:Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RoBoT.."RoBoT:Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(RoBoT.."RoBoT:Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RoBoT.."RoBoT:TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RoBoT.."RoBoT:TheBasicsQ:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RoBoT.."RoBoT:Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RoBoT.."RoBoT:Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RoBoT.."RoBoT:Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RoBoT.."RoBoT:Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RoBoT.."RoBoT:Redisa:Groups") 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RoBoT.."RoBoT:BanGroup:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"* ⌯ تم مسح المحظورين *", 'md', false)
end
elseif Text and Text:match('(%d+)/SilentGroupGroup') then
local UserId = Text:match('(%d+)/SilentGroupGroup')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(RoBoT.."RoBoT:SilentGroup:Group"..ChatId) 
